...
# Shift At Midnight Wiki — Complete Guide Hub
...
| [Doppelganger Guide](/guides/doppelganger-guide) | Spotting impostors | Intermediate |
| [Co-op Strategy Guide](/guides/coop-strategy-guide) | Team play | Starter |
| [Entity Survival Guide](/guides/entity-survival-guide) | Monster encounters | Intermediate |
| [Enemy Bestiary](/guides/enemy-bestiary) | All enemy types | Intermediate |
| [Endings Guide](/guides/endings-guide) | Story unlocks | Advanced |
| [Weapon Tier List](/tier-list) | Weapon rankings | Starter |
| [Weapons Guide](/guides/weapons-guide) | Loadout planning | Starter |
| [Tools & Traps Guide](/guides/tools-traps-guide) | Equipment setup | Intermediate |
| [NET Database Guide](/guides/net-database-guide) | Investigation tool | Intermediate |
...
### Doppelganger Guide
Master all known doppelganger types — their disguises, behavioral tells, and how to use the NET Database to expose them before they strike. [Read the full guide →](/guides/doppelganger-guide)

### Entity Survival Guide
Not every monster hides in plain sight. Learn how to survive encounters with shadow entities, crawling horrors, and the station's own dark past. [Survival tips →](/guides/entity-survival-guide)
...
- **NET Database** — Computer terminal for cross-referencing customer identities against known doppelganger data
- **Doppelganger Detection** — Behavioral tells, distorted reflections, ID check failures, and flickering under fluorescent lights
- **Weapons & Combat** — Flamethrower, Shotgun, SMG, Pistol, Sledgehammer, Baseball Bat, Brick
- **Tools & Traps** — Bear Traps, Wooden Boards, Hose, Electrical Trap, Motion Alarm, Tripwire
