...
export const metadata: Metadata = {
  title: 'All Guides',
  description:
    'Complete Shift At Midnight guide collection — beginner tips, doppelganger identification, co-op strategy, entity survival, weapons, endings, and more.',
};
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-12">
      ...
      <p className="text-gray-400 mb-8">
        {guides.length} guides covering every aspect of Shift At Midnight.
      </p>
