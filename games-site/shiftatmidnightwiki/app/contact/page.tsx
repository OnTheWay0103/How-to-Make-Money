...
export const metadata: Metadata = {
  title: 'Contact Us',
  description: 'Contact Shift At Midnight Wiki — get in touch for questions, corrections, or feedback.',
};
...
export default function ContactPage() {
  return (
    <div className="max-w-3xl mx-auto px-4 py-12 prose prose-invert">
      ...
      <h2>Email</h2>
      <p>
        You can contact us at: <a href="mailto:contact@shiftatmidnightwiki.vercel.app">contact@shiftatmidnightwiki.vercel.app</a>
      </p>
