/**
 * Next.js Metadata API helpers for Shift At Midnight Wiki.
 *
 ...
 *
 * - title uses a template so child pages produce `Page Name · Shift At Midnight Wiki`
...
export const defaultMetadata: Metadata = {
  ...
  keywords: [
    ...
    'Shift At Midnight beginner guide',
