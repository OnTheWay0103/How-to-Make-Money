 ...
 *
 * Describes Big Walk as a software application / video game so
...
export function videoGameSchema(): Record<string, unknown> {
  return {
    ...
    name: 'Big Walk',
    description:
      'A 2-12 player co-op open world puzzle adventure by House House, the creators of Untitled Goose Game. Explore a vast island, solve large-scale co-op puzzles, and talk your way across the map with walkie-talkies and proximity voice chat. No combat — just teamwork.',
    url: 'https://store.steampowered.com/app/1478500/Big_Walk/',
    applicationCategory: 'Game',
    operatingSystem: 'Windows, macOS',
    genre: ['Adventure', 'Co-op', 'Puzzle', 'Open World', 'Exploration'],
    author: {
      '@type': 'Organization',
      name: 'House House',
    },
    ...
    platform: ['Steam', 'PlayStation 5', 'Nintendo Switch 2'],
  };
}
 ...
 * @example
 *   faqPageSchema([
 *     { question: 'Is Big Walk free?', answer: 'No, it is a paid game on Steam.' },
 *     { question: 'Can I play solo?',  answer: 'No — Big Walk is co-op only (2–12 players).' },
 *   ])
 */
