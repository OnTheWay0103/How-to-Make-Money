...
export const metadata: Metadata = {
  title: 'About Us',
  description: 'About Big Walk Wiki — an unofficial fan wiki. Learn about our research standards, editorial process, and how we verify game information.',
};
...
export default function AboutPage() {
  return (
    <div className="max-w-3xl mx-auto px-4 py-12 prose prose-invert">
      ...
      <p>
        We research, organize, and verify game information to help groups of 2-12 players get the most out of their walks across the island. Our mission is to be the most helpful and accurate guide resource for the Big Walk community.
      </p>
      ...
      <ul>
        ...
        <li><strong>Secrets & Hidden Content:</strong> Gourd locations, hidden questlines, secret areas and reward mechanics as the community discovers them</li>
