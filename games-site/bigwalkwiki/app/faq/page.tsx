...
const FAQ_ITEMS = [
  ...
  { question: 'What tools are in Big Walk?', answer: 'Confirmed tools and toys include walkie-talkies, binoculars, laser pointers, megaphones, flares, flashlights, whiteboards, cowbells and a big golden head. The walkie-talkie is the communication workhorse — voices crackle through it over long distances.' },
  ...
  { question: 'What are the PC system requirements?', answer: 'Per the official Steam store listing: Minimum is Windows 10, Intel Core i7-7700K or AMD Ryzen 5 1600X, 12 GB RAM, GTX 750 Ti (2GB) / Radeon R7 370 (2GB) / Intel Arc A380. Recommended is Windows 11, Intel Core i5-10600K or Ryzen 7 3700X, 16 GB RAM, GTX 1070 (8GB) / Radeon RX 5600 XT (8GB) / Intel Arc A750.' },
  { question: 'Is Big Walk on Steam Deck?', answer: 'Not officially confirmed at launch. The minimum specs are modest, so it may run, but Steam Deck verification status is not yet confirmed. Check back — we will update this answer once it is verified or community-tested.' },
