...
export const metadata: Metadata = {
  title: 'All Guides',
  description:
    'Complete Big Walk guide collection — beginner guides, co-op and multiplayer tips, tool breakdowns, puzzle mechanics, hidden secrets, island exploration and more.',
};
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-12">
      ...
      <p className="text-gray-400 mb-8">
        {guides.length} guides covering every aspect of Big Walk.
      </p>
