...
export const metadata: Metadata = {
  ...
  description: 'Terms of Service for Big Walk Wiki — conditions for using our website.',
};
...
export default function TermsPage() {
  return (
    <div className="max-w-3xl mx-auto px-4 py-12 prose prose-invert">
      ...
      <p>
        By accessing and using Big Walk Wiki (<strong>bigwalkwiki.vercel.app</strong>), you agree to be bound by these Terms of Service. If you do not agree, please do not use our website.
      </p>

      <h2>2. Description of Service</h2>
      <p>
        Big Walk Wiki is an unofficial fan-made guide and wiki website for the video game "Big Walk." We provide game guides, tips, strategies, and related information. We are not affiliated with, endorsed by, or connected to the game's developers or publishers.
      </p>
      ...
      <p>
        Big Walk Wiki and its operators shall not be liable for any damages arising from the use or inability to use this website. This includes, but is not limited to, direct, indirect, incidental, or consequential damages.
      </p>
