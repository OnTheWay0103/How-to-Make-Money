...
# Elixirs & Alchemy Guide — Brewing Potions in Ardent Wilds

Ardent Wilds is one of those survival games where the strongest player is not necessarily the best fighter — it is often the one who walked into the fight **buffed**. The game's official description confirms **"brewing powerful elixirs"** as a core system alongside growing crops and cooking meals, and states these elixirs exist "to aid you in battle."
...
The one thing we know for certain comes straight from the official game description:

> Grow crops, cook delicious meals, and brew powerful elixirs to aid you in battle.
...
The confirmed pipeline from raw world to combat buff looks like this:

```
Forage & Farm            →   Reagents                →   Elixirs
(wild plants, crops,     →   (ingredient inventory   →   (brewed potions,
 rare cave materials)        at your base)               healing & buffs)
```
...
## Elixir Categories — What to Expect

No official category list exists, but the genre-standard pattern plus the confirmed "aid in battle" phrasing points to three expected families. Treat the names as descriptive, not official:

| Category | Expected Purpose | Notes |
|----------|-----------------|-------|
...
Because elixirs are the combat consumable layer, they matter most at the three pressure points of the game:

### 1. Before Boss Fights
...
Caves and mines are the confirmed home of rare materials, traps, and fierce enemies — and the worst place to run out of healing. Brew before you descend.

### 3. In Co-op

With up to 6 players (confirmed), elixirs become a **team resource**:

- One designated **brewer/alchemist** in the party keeps the whole group stocked — it is the consumable equivalent of the cook role in the [Farming & Cooking Guide](farming-cooking-guide.md)
- Coordinate buff windows before a boss pull instead of everyone popping elixirs at random
- Share ingredient surplus — one player's farm surplus is another player's healing kit

## Setting Up Your Brewing Corner
...
- Whether buffs stack, share timers, or overwrite each other
- Elixir duration and intensity numbers
