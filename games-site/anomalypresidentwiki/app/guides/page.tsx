...
export const metadata: Metadata = {
  title: 'All Guides',
  description:
    'Complete Anomaly President guide collection — the day/night dual loop, campaign management, campaign bus, Fluffies, night combat, weapons, Anomaly Powers, bosses, builds, EA status, and more.',
};
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-12">
      ...
      <p className="text-gray-400 mb-8">
        {guides.length} guides covering every aspect of Anomaly President.
      </p>
