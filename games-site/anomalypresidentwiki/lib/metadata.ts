/**
 * Next.js Metadata API helpers for Anomaly President Wiki.
 *
 ...
 *
 * - title uses a template so child pages produce `Page Name · Anomaly President Wiki`
...
export const defaultMetadata: Metadata = {
  ...
  keywords: [
    'Anomaly President',
    'Anomaly President wiki',
    'Anomaly President guide',
    'Anomaly President EA',
    'Anomaly President Phew Phew',
    'Anomaly President campaign',
    'Anomaly President Fluffies',
    'Anomaly President campaign bus',
    'Anomaly President combat',
    'Anomaly President Anomaly Powers',
  ],
