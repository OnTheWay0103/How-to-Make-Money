 ...
 *
 * Describes Anomaly President as a software application / video
 * game so rich results can display the Steam link, genre, platform, etc.
 */
export function videoGameSchema(): Record<string, unknown> {
  return {
    '@context': 'https://schema.org',
    '@type': 'VideoGame',
    name: 'Anomaly President',
    description:
      'A presidential-campaign roguelike action game. Gather votes and run for president by day, then transform into a warrior to take down the corrupt president\'s criminal gangs by night. Recruit Fluffies, build your campaign bus, and steal Anomaly Powers from bosses.',
    url: 'https://store.steampowered.com/app/3156330/Anomaly_President/',
    applicationCategory: 'Game',
    operatingSystem: 'Windows',
    genre: ['Action', 'Roguelike', 'Roguelite', 'Hack and Slash', 'Base Building', 'Indie', 'RPG'],
    author: {
      '@type': 'Organization',
 ...
 * @example
 *   faqPageSchema([
 *     { question: 'Is Anomaly President free?', answer: 'No, it is a paid Early Access game on Steam.' },
