...
export const metadata: Metadata = {
  title: 'All Guides',
  description:
    'Complete Skills & Raids guide collection — beginner guides, character builds, ability system, extraction strategies, progression tips, and more.',
};
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-12">
      ...
      <p className="text-gray-400 mb-8">
        {guides.length} guides covering every aspect of Skills & Raids.
      </p>
