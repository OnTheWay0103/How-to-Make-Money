...
export const metadata: Metadata = {
  title: 'All Guides',
  description:
    'Complete Mistfall Hunter guide collection — class builds, extraction tips, weapon guides, tier lists, camp upgrades, and more.',
};
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-12">
      ...
      <p className="text-gray-400 mb-8">
        {guides.length} guides covering every aspect of Mistfall Hunter.
      </p>
