/**
 * Next.js Metadata API helpers for Mistfall Hunter Wiki.
 *
 ...
 *
 * - title uses a template so child pages produce `Page Name · Mistfall Hunter Wiki`
...
export const defaultMetadata: Metadata = {
  ...
  keywords: [
    ...
    'Mistfall Hunter tips',
    'Mistfall Hunter tier list',
    'Mistfall Hunter extraction',
