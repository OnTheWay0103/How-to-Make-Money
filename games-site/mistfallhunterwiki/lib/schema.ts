 ...
 *
 * Describes Mistfall Hunter as a software application / video game so
...
export function videoGameSchema(): Record<string, unknown> {
  return {
    ...
    description:
      'A dark fantasy PvPvE extraction ARPG. Choose from 6 unique classes, scavenge Gyldenblood in mist-shrouded ruins, fight Corroded and rival players, and extract before the mist consumes everything.',
    url: 'https://store.steampowered.com/app/mistfall-hunter',
 ...
 * @example
 *   faqPageSchema([
 *     { question: 'Is Mistfall Hunter free?', answer: 'No, it is a paid game on Steam.' },
