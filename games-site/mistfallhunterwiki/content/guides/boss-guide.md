...
| Team (3) | Any balanced comp with 1 tank | Blue+ across the board |

### Strategies

- **Solo**: Kite around the central pillar. Punish the charge animation with 2-3 hits, then reset. Do not facetank Phase 2 — the mist aura melts you.
- **Duo**: One player kites the boss while the other clears adds. Swap aggro when the active kiter runs low on stamina.
- **Team**: All three focus the boss in Phase 1. At Phase 2, designate one player for add control. The tank should position the boss away from the add spawn points.

> **Watch for third-parties**: The Catacombs boss room has two entrances. Have one player watch the door during Phase 2.

## 2. Forsaken Hollow — The Hollow Warden

### Location
Underground arena, accessible through the well in the village center.
...
| Team | Sorcerer + Withered Knight + Seer | Blue+ gear |

### Strategies

- **Solo (Shadowstrix)**: Stay in stealth, ambush the boss, then re-stealth. Use Poison pools as a zone — the boss walks through them but you jump over.
- **Duo**: Blackarrow ranges from the upper ledge (safe from Chain Pull). Seer kites on ground level and heals through poison chip damage.
- **Team**: Sorcerer burns adds and deals AoE. Withered Knight parries the Chain Pull for counter-attack openings. Seer keeps everyone above 70% HP.

## 3. Mistveil Forest — The Verdant Ancient

### Location
Clearing in the north-east corner of the map, surrounded by three returner shrines.

### Mechanics

| Phase | HP Threshold | Behavior |
|-------|-------------|----------|
| Phase 1 | 100% - 70% | Root slam, vine sweep, seed pod spawn |
| Phase 2 | 70% - 40% | Vine sweep becomes triple swipe, roots erupt under players |
| Phase 3 | Below 40% | Entire arena becomes active — roots, seeds, and sweeping vines simultaneously |
...
| Phase | HP Threshold | Behavior |
|-------|-------------|----------|
| Phase 1 | 100% - 50% | Lunge bite, tail whip, spawns blood leeches |
| Phase 2 | Below 50% | Enrages — bite applies bleed, water boils for DoT |

### Key Attacks

- **Lunge Bite**: Lunges at a player, applying bleed. Roll perpendicular to the lunge direction.
- **Tail Whip**: 360-degree sweep. Jump to avoid.
- **Blood Leeches**: Small enemies that latch on and drain HP. Roll to shake them off.
- **Boiling Water** (Phase 2): The entire arena water pool deals ticking damage. Kite the boss to the raised platforms.
...
| Team | Balanced comp + Seer | Blue+ gear |

### Strategies

- **Solo**: Use the raised platforms. Fight on platforms to avoid water. The boss follows you — parry the lunge for free damage windows.
- **Duo**: Mercenary tanks on platforms. Shadowstrix ambushes from water (stealth ignores slow). Rotate platforms when water boils.
- **Team**: Stack on the same platform. Seer cleanses bleeds. All three focus leeches before they stack.

## 5. The Obsidian Depths — Shattered King

### Location
Final boss in the deepest map. Requires defeating a mini-boss (Obsidian Guard) to unlock the portal.

### Mechanics

| Phase | HP Threshold | Behavior |
|-------|-------------|----------|
| Phase 1 | 100% - 75% | Slow heavy hits, crystal shard barrage |
| Phase 2 | 75% - 40% | Summons Obsidian pillars (provide cover or danger), shatter attack |
| Phase 3 | Below 40% | Arena collapse — floor sections fall away, tight DPS window |

### Key Attacks

- **Crystal Barrage**: Shoots shards in a cone. Hide behind a pillar.
- **Shatter** (Phase 2): Destroys all Obsidian pillars, dealing damage and stunning. Hug the boss when this starts — the center is safe.
- **Floor Collapse** (Phase 3): Sections of the arena drop. Stay on the center platform. The fight becomes a tight circle.
...
| Team | Full squad with Seer | Purple+ gear, legendary weapon recommended |

### Strategies

- **Duo**: Shadowstrix maintains constant damage. Sorcerer stays at range. During Shatter, both hug the boss. In Phase 3, Shadowstrix kites and Sorcerer bursts.
- **Team**: Assign pillar duty — one player kites the boss, two manage pillars. Phase 3 is pure DPS: pop all cooldowns and burn.

## Boss Tier List (Difficulty vs. Reward)

| Boss | Difficulty | Loot Value | Solo-Friendly | Risk of Third-Party |
|------|-----------|------------|--------------|-------------------|
| Returner Woodling | Easy | Medium | Yes | Low |
| Hollow Warden | Medium | High | With specific build | Medium |
| Verdant Ancient | Medium-Hard | High | With ranged build | High |
| Blood Matriarch | Hard | Very High | Difficult | Medium |
| Shattered King | Very Hard | Legendary | No | Very High |

## General Boss Tips

- **Always clear the area first**: Kill nearby mobs before engaging the boss. Add spawns + boss is a wipe.
