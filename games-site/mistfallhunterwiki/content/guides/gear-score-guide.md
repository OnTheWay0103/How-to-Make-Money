---
title: "Mistfall Hunter Gear Score Guide — How It's Calculated and How to Raise It"
...
## 1. What Determines Gear Score

Gear score is the sum of three components per item:

| Component | What It Is | Weight |
|-----------|-----------|--------|
| Rarity base | Common → Uncommon → Rare → Epic → Legendary | The largest chunk of the score |
| Affix count | Bonus modifiers per item (1-3 for gear, more for named items) | Adds score per affix |
| Upgrade level | Camp upgrades and item enhancement | Adds score per level |

**Practical consequence:** a Rare item with 3 affixes out-scores an Epic with 1 affix. Rarity is the baseline, but affixes decide the ceiling — this is why the [Loot Rarity Guide](/guides/loot-rarity-guide) and the [Loadout Optimizer Guide](/guides/loadout-optimizer) matter more than raw item color.

---

## 2. The Score Thresholds That Matter

| Zone / Content | Recommended Score | Reality If Under |
|----------------|-------------------|------------------|
| Map edges / spawn areas | Any | Fine — this is where you start |
...
- Withering-affixed gear (with special affixes) counts for more score than same-tier normal gear.

---

## 4. The Fastest Score-Raising Routes

| Route | Time | Score Gain | Notes |
|-------|------|-----------|-------|
| Budget runs on map edges | 5-8 min each | Low per item, high per hour | Sell everything; buy upgrades (see the [Economy Guide](/guides/economy-guide)) |
| Mid-map ruins | 15-20 min | Medium | Best common-to-rare conversion rate |
| Withering-afflicted zones | 20-30 min | High | One tier up on every drop; bring Salves |
| Named POIs | 25-40 min | Very high | Epic drops, but contested — go with a squad |
| Camp upgrades | Ongoing | Permanent | The only score gain that survives a death |

**The trap:** buying gear on the market instead of farming it. You lose Gyldenblood that could fund permanent camp upgrades — and camp upgrades (see the [Camp Upgrades Guide](/guides/camp-upgrades-guide)) are the only score that can't be lost in an extraction.

---

## 5. When to Equip vs. When to Sell

| Situation | Decision | Why |
|-----------|----------|-----|
| Item is 1+ rarity above your current slot | Equip | Immediate score jump |
| Item has more affixes than current | Equip | Affix count matters more than rarity tier |
| Item is same tier, same affixes | Sell | Dead value — Gyldenblood is real |
| You're 100 Gyldenblood from a camp upgrade | Sell the marginal item | Permanent progress beats marginal score |
| Withering-affixed duplicate | Sell | The affix premium means it's worth real money |

---

## 6. Common Mistakes

1. **Chasing legendary drops in zones you can't survive.** The returner's graveyard is full of players who ran at the Woodling zone with common gear.
