---
title: "Mistfall Hunter Beginner Class Guide — Which Class to Start With"
...
## 2. The Three Best Beginner Picks
...
### 2. Seer — For Squad Players

- **Why:** the only support/healer class. In Trio queue, a Seer roughly doubles the squad's safe extraction rate.
- **Core loop:** keep the lantern and catalyst up, heal teammates between fights, buff damage windows.
- **Honest caveat:** the Seer is weak solo — if you play mostly Solo queue, pick Mercenary instead.
- **Best for:** players whose friends are already in the game.

### 3. Sorcerer — For Comfortable Gamers

- **Why:** the highest damage ceiling with strong team-fight AoE. Fire/Ice/Thunder cycling plus the Stardust spec offers instant-cast burst.
- **Honest caveat:** the most fragile class when caught — positioning is everything. Not a first-pick for total newcomers.
- **Key talent:** Elemental Resonance (damage boosts when cycling elements).
- **Best for:** players with extraction or shooter experience who want to main DPS.

---

## 3. Quick Picks by Your Situation

| Your Situation | Pick | Why |
|----------------|------|-----|
| Never played an extraction game | Mercenary | Block is a real, learnable defensive tool |
| Playing with a fixed trio | Seer | The healer slot wins trios |
| Playing solo only | Mercenary or Blackarrow | Survival, or range + sightlines |
| PvP ambitions | Shadowstrix | The ambush kit is the PvP standard |
| Want the highest ceiling | Sorcerer | Best DPS, hardest to play well |
| Like counter-play | Withered Knight | Frontline disruption for organized squads |

---

## 4. The Class-Change System (Use It Early, Use It Free)

Classes are switched at your camp between extractions — there is no level penalty for switching, but you do rebuild talent progression per class. **Practical advice for beginners:** play Mercenary for your first 5-10 extractions to learn the loop, then experiment. The [Class Change Guide](/guides/class-change-guide) covers the exact costs and what carries over.
...
**Final note:** class choice in Mistfall Hunter is a preference, not a sentence — the game's design (free switching, no pay-to-win, camp progression shared across classes) means the best class is the one you extract with most. Pick Mercenary to start, then follow your playstyle.
