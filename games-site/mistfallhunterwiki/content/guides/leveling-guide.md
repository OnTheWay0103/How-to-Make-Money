...
Leveling in Mistfall Hunter unlocks skill points, talent slots, and access to higher-tier content. Your character level persists between extractions — dying does not reduce XP.

### Level Caps and Unlocks
...
| Source | XP per Hour | Risk | Consistency |
|--------|------------|------|------------|
| Quick extractions (5-7 min) | High | Low | Very consistent |
| Boss kills | Very High | Medium | Variable (competition) |
| PvP kills | Medium-High | High | Inconsistent |
| Mob farming | Low-Medium | Low | Consistent but slow |
| Exploration/Discovery | Low | Very Low | One-time bonuses |
...
**Goal**: Consistent extraction loops, introduce boss kills
...
**Goal**: Consistent boss farming, introduce Mistveil Forest
...
**Goal**: Obsidian Depths, leaderboard competition
