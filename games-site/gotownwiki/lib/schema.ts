...
export function videoGameSchema(): Record<string, unknown> {
  return {
    ...
    name: 'Go-Go Town!',
    description:
      'A 1-4 player co-op city builder and life sim by Prideful Sloth. Rebuild a rundown tourist town, attract visitors, hire Townies, automate production chains, and manage the chaos of your own Go-Go Town.',
    url: 'https://store.steampowered.com/app/2195120/GoGo_Town/',
    applicationCategory: 'Game',
    operatingSystem: 'Windows',
    genre: ['City Builder', 'Co-op', 'Life Sim', 'Management', 'Simulation', 'Relaxing'],
    author: {
      '@type': 'Organization',
      name: 'Prideful Sloth',
    },
