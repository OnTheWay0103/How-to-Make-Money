/**
 * Next.js Metadata API helpers for Go-Go Town! Wiki.
 *
 ...
 *
 * - title uses a template so child pages produce `Page Name · Go-Go Town! Wiki`
...
export const defaultMetadata: Metadata = {
  ...
  keywords: [
    ...
    'Go-Go Town! wiki',
    'Go-Go Town! guide',
    'Go-Go Town! how to make money',
    'Go-Go Town! best layout',
    'Go-Go Town! beginner guide',
    'Go-Go Town! automation',
    'Go-Go Town! co-op',
    'Go-Go Town! tourists',
    'Go-Go Town! tips and tricks',
  ],
