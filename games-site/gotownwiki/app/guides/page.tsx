...
export const metadata: Metadata = {
  title: 'All Guides',
  description:
    'Complete Go-Go Town! guide collection — beginner tips, money making, town layouts, automation, tourists, co-op multiplayer, treasure hunting, and more.',
};
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-12">
      ...
      <p className="text-gray-400 mb-8">
        {guides.length} guides covering every aspect of Go-Go Town!.
      </p>
