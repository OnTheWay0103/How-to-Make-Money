/**
 * Next.js Metadata API helpers for BOMBANANA! Wiki.
 *
 ...
 *
 * - title uses a template so child pages produce `Page Name · BOMBANANA! Wiki`
...
export const defaultMetadata: Metadata = {
  ...
  keywords: [
    ...
    'BOMBANANA roles',
    'BOMBANANA modules',
    'BOMBANANA 3-player co-op',
    'BOMBANANA beginner guide',
    'BOMBANANA bomb defusal',
  ],
