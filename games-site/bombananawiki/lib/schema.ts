 ...
 *
 * Describes BOMBANANA! as a software application / video
...
export function videoGameSchema(): Record<string, unknown> {
  return {
    ...
    name: 'BOMBANANA!',
    description:
      'A chaotic, asymmetrical 3-player co-op bomb-defusal party game. A blind, a deaf, and a mute monkey must work together to defuse bombs, each holding only part of the information. Communicate, solve puzzle modules, and race against the clock.',
    url: 'https://store.steampowered.com/app/4656000/BOMBANANA/',
    applicationCategory: 'Game',
    operatingSystem: 'Windows',
    genre: ['Puzzle', 'Co-op', 'Party Game', 'Multiplayer', 'Casual', 'Comedy', 'Indie'],
    author: {
      '@type': 'Organization',
      name: 'Lefto Studio',
    },
 ...
 * @example
 *   faqPageSchema([
 *     { question: 'Is BOMBANANA! free?', answer: 'No, it is a paid game on Steam.' },
