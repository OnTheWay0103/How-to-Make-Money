...
export const metadata: Metadata = {
  title: 'All Guides',
  description:
    'Complete BOMBANANA! guide collection — how to play, blind/deaf/mute roles, bomb modules (wires, numpad, switch panels), manual, callouts, Free Mode, demo, co-op, and more.',
};
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-12">
      ...
      <p className="text-gray-400 mb-8">
        {guides.length} guides covering every aspect of BOMBANANA!.
      </p>
