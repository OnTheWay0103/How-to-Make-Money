/**
 * Next.js Metadata API helpers for Doloc Town Wiki.
 *
 ...
 *
 * - title uses a template so child pages produce `Page Name · Doloc Town Wiki`
...
export const defaultMetadata: Metadata = {
  ...
  keywords: [
    ...
    'Doloc Town recipes',
    'Doloc Town crops',
    'Doloc Town drone automation',
    'Doloc Town 1.0',
    'post-apocalyptic farming sim',
    'RedSaw Games',
  ],
