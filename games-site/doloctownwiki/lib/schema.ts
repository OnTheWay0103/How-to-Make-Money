 ...
 *
 * Describes Doloc Town as a software application / video game so
...
export function videoGameSchema(): Record<string, unknown> {
  return {
    ...
    name: 'Doloc Town',
    description:
      'A cozy side-scrolling post-apocalyptic farming simulator from RedSaw Games. Build a vertical farm one platform at a time, grow 30+ crops, fish, ranch animals, and automate the farm with drones while surviving acid rain, heat waves, and storms.',
    url: SITE_CONFIG.url,
    applicationCategory: 'Game',
    operatingSystem: 'Windows',
    genre: ['Farming Sim', 'Post-Apocalyptic', 'Life Sim', 'Indie'],
    author: {
      '@type': 'Organization',
      name: 'RedSaw Games',
    },
