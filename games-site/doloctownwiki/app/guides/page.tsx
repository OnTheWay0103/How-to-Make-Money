...
export const metadata: Metadata = {
  title: 'All Guides',
  description:
    'Complete Doloc Town guide collection — beginner tips, money-making strategies, crops, fishing, recipes, drone automation, and more.',
};
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-12">
      ...
      <p className="text-gray-400 mb-8">
        {guides.length} guides covering every aspect of Doloc Town.
      </p>
