...
export const metadata: Metadata = {
  title: 'About Us',
  description: 'About Doloc Town Wiki — an unofficial fan wiki. Learn about our research standards, editorial process, and how we verify game information.',
};

export default function AboutPage() {
  return (
    <div className="max-w-3xl mx-auto px-4 py-12 prose prose-invert">
      <h1>About Doloc Town Wiki</h1>

      <h2>Who We Are</h2>
      <p>
        Doloc Town Wiki is an <strong>unofficial fan-made resource</strong> dedicated to "Doloc Town," the cozy post-apocalyptic farming simulator developed by RedSaw Games and published by Logoi Games.
      </p>
      <p>
        We research, organize, and verify game information to help players build better farms, earn more Goldcoin, and survive the wasteland. Our mission is to be the most helpful and accurate guide resource for the Doloc Town community.
      </p>

      <h2>What We Offer</h2>
      <ul>
        <li><strong>Game Guides:</strong> Beginner guides, money-making strategies, and progression guides</li>
        <li><strong>System Breakdowns:</strong> Crops, fishing, recipes, ranching, and drone automation explained</li>
        <li><strong>Region Coverage:</strong> Rivervalley, Wetlands, Old City Ruins, and the caves</li>
      ...
      <p>
        Each guide includes a <strong>Sources</strong> section showing where the information comes from. If you find information that is outdated or incorrect, please <a href="/contact">let us know</a>.
      </p>
      ...
      <h2>Disclaimer</h2>
      <p>
        <strong>Doloc Town Wiki is not affiliated with, endorsed by, or connected to RedSaw Games, Logoi Games, or any of their subsidiaries or affiliates.</strong> All game-related trademarks, images, and content are the property of their respective owners. This site is an independent fan project created to support the game's community.
      </p>
      <p>
