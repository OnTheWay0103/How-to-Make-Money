...
## Device Database (Launch Build)

| Device | Category | Brand Status | Repair Notes |
|--------|----------|:---:|-------------|
| **Atari 2600** | Console (home) | ✅ Licensed | Classic cartridge console; casing work + board cleaning, occasional soldering |
| **Atari Lynx** | Console (handheld) | ✅ Licensed | Handheld with screen and board work |
| **Atari CX40** | Controller | ✅ Licensed | Joystick; simple internals, good early job |
| **Nony PlayMachine** | Console (home) | Parody | Sony PlayStation-style stand-in |
| **Nony PMP** | Console (portable) | Parody | Portable media player style device |
| **Patento BS** | Handheld console | Parody | PSP-style handheld; appeared in the demo |
| **Pokia 3310** | Phone | Parody | Nokia 3310 stand-in; tiny circuit boards + keypad work |
| **Pokia Njoy** | Phone | Parody | Nokia N-Gage-style stand-in |
| **Autorolla Razor** | Phone (flip) | Parody | Motorola Razr-style flip phone |
| **Eggotchi** | Virtual pet | Parody | Tamagotchi-style digital pet |
| **Nony Goman** | Music player (cassette) | Parody | Walkman-style cassette player; **most involved job** — many small moving parts |
| **Palaloid** | Camera (instant) | Parody | Polaroid-style instant camera |
| **Walkie-talkie** | Communication | Parody | Simple two-way radio internals |
...
| Device Type | Source |
|-------------|--------|
| Laptops | Smashpad review |
| Aibo-style robot dogs | Reviews |
| Guitar Hero-style controllers | Smashpad review |
| Atari Jaguar (licensed) | Playtest-era press release |
| Digital cameras | Press materials |
| Home appliances | Press materials |

---

## Officially Licensed vs. Parody Devices

| Real-World Item | In-Game Name | Licensed? |
|-----------------|--------------|:---:|
| Atari 2600 | Atari 2600 | ✅ |
| Atari Lynx | Atari Lynx | ✅ |
| Atari CX40 joystick | Atari CX40 | ✅ |
| Nokia 3310 | Pokia 3310 | ❌ Parody |
| Nokia N-Gage | Pokia Njoy | ❌ Parody |
| Motorola Razr | Autorolla Razor | ❌ Parody |
| Tamagotchi | Eggotchi | ❌ Parody |
| Walkman (cassette) | Nony Goman | ❌ Parody |
| Polaroid camera | Palaloid | ❌ Parody |
| Sony PlayStation | Nony PlayMachine | ❌ Parody |
| Sony PSP | Patento BS | ❌ Parody |
| Sony Aibo | Robodog | ❌ Parody |
...
- **Keep broken devices.** A cheap junk device can contain several usable parts worth far more than its purchase price — salvage LCD assemblies, button membranes, speakers and flex cables before shredding the rest.
- **The Nony Goman** (cassette player) is the classic "hard first job" — set aside time, organize parts on the bench, and use the notepad's assembly order religiously.
- **Phone repairs** lean on tiny circuit boards and keypad work — tweezers are mandatory, and a good magnifier makes the difference.
- **Soldering appears on consoles and anything with boards** — see the [Repair Process Guide](/guides/repair-process-guide) before your first board repair.
