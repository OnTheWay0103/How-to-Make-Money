/**
 * Next.js Metadata API helpers for ReStory Wiki.
 *
 ...
 *
 * - title uses a template so child pages produce `Page Name · ReStory Wiki`
...
export const defaultMetadata: Metadata = {
  ...
  keywords: [
    ...
    'ReStory guide',
    'ReStory walkthrough',
    'ReStory repair guide',
    'ReStory licenses',
    'ReStory achievements',
    'ReStory all devices',
    'ReStory beginner guide',
    'ReStory money making',
  ],
