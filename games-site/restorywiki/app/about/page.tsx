...
export const metadata: Metadata = {
  title: 'About Us',
  description: 'About ReStory Wiki — an unofficial fan wiki for ReStory: Chill Electronics Repairs. Learn about our research standards, editorial process, and how we verify game information.',
};
...
export default function AboutPage() {
  return (
    <div className="max-w-3xl mx-auto px-4 py-12 prose prose-invert">
      ...
      <p>
        We research, organize, and verify game information to help players run the coziest repair shop in mid-2000s Akihabara. Our mission is to be the most helpful and accurate guide resource for the ReStory community.
      </p>

      <h2>What We Offer</h2>
      <ul>
        <li><strong>Game Guides:</strong> Beginner guides, repair process breakdowns, and story walkthroughs</li>
        <li><strong>Reference Databases:</strong> Complete device lists, license guides, and all 50 achievements</li>
        <li><strong>Money-Making Tips:</strong> Profit strategies, online-order management, marketplace flipping, and spare-part salvage</li>
      ...
      <ul>
        <li><strong>Verification first:</strong> Numerical values (costs, counts, timings) are only included where they can be verified against official sources or consistent community consensus — anything unconfirmed is explicitly marked as unverified</li>
