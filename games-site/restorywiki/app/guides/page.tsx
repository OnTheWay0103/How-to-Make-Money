...
export const metadata: Metadata = {
  title: 'All Guides',
  description:
    'Complete ReStory: Chill Electronics Repairs guide collection — device database, repair process, license system, all 50 achievements, money-making tips and more.',
};
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-12">
      ...
      <p className="text-gray-400 mb-8">
        {guides.length} guides covering every aspect of ReStory: Chill Electronics Repairs.
      </p>
