 ...
 *
 * Describes Dwarf Delve as a software application / video game so
...
export function videoGameSchema(): Record<string, unknown> {
  return {
    ...
    name: 'Dwarf Delve',
    description:
      'A first-person extraction roguelite where you play as a Delveling dwarf descending into procedurally generated mines. Mine ores and relics, fight dangers, build rail networks, craft supports, and extract before the tunnels collapse. Upgrade your gear and customize your dwarven quarters between runs.',
    url: 'https://store.steampowered.com/app/2237320/Dwarf_Delve/',
    applicationCategory: 'Game',
    operatingSystem: 'Windows',
    genre: ['Extraction', 'Roguelite', 'First-Person', 'Mining', 'Crafting', 'Action'],
    author: {
      '@type': 'Organization',
      name: 'Gloom Box',
    },
