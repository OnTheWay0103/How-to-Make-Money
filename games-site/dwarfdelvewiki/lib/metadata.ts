/**
 * Next.js Metadata API helpers for Dwarf Delve Wiki.
 *
 ...
 *
 * - title uses a template so child pages produce `Page Name · Dwarf Delve Wiki`
...
export const defaultMetadata: Metadata = {
  ...
  keywords: [
    ...
    'Dwarf Delve wiki',
    'Dwarf Delve guide',
    'Dwarf Delve beginner guide',
    'Dwarf Delve mining',
    'Dwarf Delve gear',
    'Dwarf Delve perks',
    'Dwarf Delve skills',
    'Dwarf Delve crafting',
    'Dwarf Delve extraction',
    'Dwarf Delve minecart',
    'Dwarf Delve tips',
    'Dwarf Delve enemies',
    'Dwarf Delve biomes',
    'Gloom Box',
...
export interface GuideFrontmatter {
  ...
  keywords: string[];
  /** ISO‑8601 date of last content update (e.g. "2026-07-25") */
  updated: string;
 ...
 *     title: 'Mining Strategies Guide',
 *     description: '...',
 *     keywords: ['mining', 'strategies'],
 *     updated: '2026-07-25',
