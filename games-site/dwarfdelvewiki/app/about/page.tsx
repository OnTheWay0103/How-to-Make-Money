...
export const metadata: Metadata = {
  title: 'About Us',
  description: 'About Dwarf Delve Wiki — an unofficial fan wiki. Learn about our research standards, editorial process, and how we verify game information.',
};

export default function AboutPage() {
  return (
    <div className="max-w-3xl mx-auto px-4 py-12 prose prose-invert">
      <h1>About Dwarf Delve Wiki</h1>

      <h2>Who We Are</h2>
      <p>
        Dwarf Delve Wiki is an <strong>unofficial fan-made resource</strong> dedicated to "Dwarf Delve," the first-person extraction roguelite developed by solo developer Gloom Box and published by indie.io.
      </p>
      <p>
        We research, organize, and verify game information to help players survive the collapsing mines. Our mission is to be the most helpful and accurate guide resource for the Dwarf Delve community.
      </p>

      <h2>What We Offer</h2>
      <ul>
        <li><strong>Game Guides:</strong> Beginner guides, mining and depth strategies, gear and tool breakdowns, and extraction tactics</li>
        <li><strong>Enemy & Hazard Coverage:</strong> Honest documentation of the game's confirmed threats, updated as the community verifies more</li>
        <li><strong>Single-Player Strategy:</strong> Build and run guidance for the game's solo-only extraction loop</li>
      ...
      <h2>Disclaimer</h2>
      <p>
        <strong>Dwarf Delve Wiki is not affiliated with, endorsed by, or connected to Gloom Box, indie.io, or any of their subsidiaries or affiliates.</strong> All game-related trademarks, images, and content are the property of their respective owners. This site is an independent fan project created to support the game's community.
      </p>
      <p>
