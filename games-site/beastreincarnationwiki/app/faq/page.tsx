...
const FAQ_ITEMS = [
  ...
  { question: 'What are the PC system requirements?', answer: 'Minimum: Windows 10/11 64-bit, Intel Core i5-8400 or AMD Ryzen 5 3600, 16 GB RAM, GTX 1070 or RX 580 (8 GB), DirectX 12, SSD required, 45–60 GB storage. These requirements are from the official Steam store listing and may change with updates. Steam Deck and controller support are listed.' },
  ...
  { question: 'What are the achievements/trophies?', answer: '46 trophies on PS5 and 45 achievements on Xbox/Steam at launch. None are missable and none are difficulty-locked, though the Platinum needs two playthroughs.' },
  ...
  { question: 'How do reviews look?', answer: 'Launch reviews were mixed. Critics praised the Emma–Koo bond, atmosphere, and parry combat; they criticized story pacing, camera issues, and launch performance on PC and Xbox (PS5 was the most stable). Steam user reviews are "Mixed" at launch, largely due to launch-day performance issues.' },
];
