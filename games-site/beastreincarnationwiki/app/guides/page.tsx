...
export const metadata: Metadata = {
  title: 'All Guides',
  description:
    'Complete Beast of Reincarnation guide collection — Nushi boss references, tier lists, builds, skill trees, combat guides, and more.',
};
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-12">
      ...
      <p className="text-gray-400 mb-8">
        {guides.length} guides covering every aspect of Beast of Reincarnation.
      </p>
