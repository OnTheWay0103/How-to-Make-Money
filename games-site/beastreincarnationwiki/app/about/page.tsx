...
export const metadata: Metadata = {
  title: 'About Us',
  description: 'About Beast of Reincarnation Wiki — an unofficial fan wiki providing game guides, tips, and strategies.',
};
...
export default function AboutPage() {
  return (
    <div className="max-w-3xl mx-auto px-4 py-12 prose prose-invert">
      ...
      <p>
        We are a small team of passionate gamers who create comprehensive guides, strategies, and resources to help players hunt Nushi, master the hybrid combat system, and reach the Capital. Our mission is to be the most helpful and up-to-date guide resource for the Beast of Reincarnation community.
      </p>
