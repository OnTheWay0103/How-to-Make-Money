...
export function videoGameSchema(): Record<string, unknown> {
  return {
    ...
    description:
      'A single-player action RPG set in post-apocalyptic Japan 4026. Emma the Sealer and her dog Koo hunt giant Nushi creatures, absorb their power, and fight the Beast of Reincarnation with a hybrid real-time parry combat system.',
    url: 'https://store.steampowered.com/app/2001760/Beast_of_Reincarnation/',
    applicationCategory: 'Game',
    operatingSystem: 'Windows',
    genre: ['Action', 'RPG', 'Soulslike', 'Third-Person', 'Singleplayer'],
    author: {
      '@type': 'Organization',
      name: 'Game Freak',
    },
