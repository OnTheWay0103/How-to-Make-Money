---
title: "Beast of Reincarnation Wiki — Complete Guide Hub"
description: "The ultimate community wiki for Beast of Reincarnation — Game Freak's single-player action RPG. Find Nushi boss references, tier lists, builds, skill trees, combat guides and more."
category: "Home"
version: "1.0.6"
updated: "2026-08-08"
...
**Everything you need to hunt Nushi, master the hybrid combat, and reach the Capital.**
...
### New Here?
- [Beginner's Guide — First 5 Hours](/guides/beginner-guide) — parrying, Koo commands, and the 10 mistakes to avoid
- [FAQ](/guides/faq) — the 20 most common questions answered
- [Price, Platforms & System Requirements](/guides/price-platforms-guide) — editions, Game Pass, and PC specs

### Bosses & Combat
- [Nushi Boss Quick Reference](/guides/nushi-boss-reference) — every boss, weakness, and drop in one table
- [Nushi Boss Tier List](/guides/tier-list) — all bosses and best skills ranked (versioned)
...
| Fact | Detail |
|------|--------|
| **Developer** | Game Freak (creators of Pokémon) |
| **Publisher** | Fictions (formerly Private Division) |
| **Director** | Kota Furushima |
| **Release** | August 4, 2026 |
| **Platforms** | PC (Steam/Microsoft Store), PS5, Xbox Series X\|S, Game Pass Ultimate day-one |
...
Set in post-apocalyptic Japan in 4026, **Beast of Reincarnation** follows Emma the Sealer — an 18-year-old Blightborn woman fused with a parasitic plant force that erased her memories and emotions — and Koo, a magical white dog who is secretly a Malefact. Together they travel from the eastern countryside toward the Capital, defeating giant Nushi creatures to absorb their power, with the goal of slaying the Beast of Reincarnation, the elk-like source of all Blight.

The story draws on Japanese Buddhist symbolism (red spider lilies, reincarnation themes) and has been compared to Princess Mononoke, Sekiro, and NieR: Automata.
