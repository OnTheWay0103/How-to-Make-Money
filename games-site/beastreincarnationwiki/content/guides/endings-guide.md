---
title: "Endings Guide — How Many Endings & How to Reach Them"
description: "How many endings Beast of Reincarnation has, what the ending requires, the Epilogue (Bearing Fruit), what happens to Koo, and everything the credits unlock — New Game+ and Reincarnation+."
category: "Endgame"
version: "1.0.6"
updated: "2026-08-09"
...
| **What unlocks at the credits?** | New Game+ and **Reincarnation+** difficulty |

The story follows Emma the Sealer and Koo from the eastern countryside to the Capital, defeating the Nushi and ultimately the **Beast of Reincarnation** — the elk-like source of all Blight — in Chapter 13 ("To Bloom, Then Fall"). The epilogue then wraps the journey, and the credits roll into the New Game+ prompt.

---

## Is There More Than One Ending?

**No verified branching has been found.** There are no reputation systems, no route choices, and no karma meters — the story is linear, and every playthrough reaches the same ending. What differs between runs is *how you get there*: which Nushi Skills you absorb, how deep your elemental builds go, and your Koo Rapport level.
...
## Reaching the Ending: The Final Stretch

The last stretch runs Chapters 10–13 in the Capital:

| Chapter | Content |
|---------|---------|
| 10 — Malefact | Starfall Tower; Shidou & Nue paired fight |
| 11 — Budding Realization | Mount Hiei Zone |
| 12 — The Firmament | Koo's Nushi form, Erymanth, and the Kunai & Kirin rematch |
...
## What the Ending Unlocks

- **New Game+** — available from the main menu with your completed save (it gains a star marker after the final boss).
...
## How Long to the Ending

- **~20 hours** rushed
- **25–28 hours** average (Normal)
- **30–35 hours** completionist (includes New Game+ progress toward the Platinum)
...
**If you discover anything about the ending that contradicts this page, it will be corrected** — the wiki's ending section is updated as post-launch guides verify the final stretch.
