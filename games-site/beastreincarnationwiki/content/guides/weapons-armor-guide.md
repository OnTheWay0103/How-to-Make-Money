---
title: "Weapons & Armor Guide — Best Swords, Armor Sets & Where to Find Them"
description: "Every sword and armor set worth farming in Beast of Reincarnation: S-tier weapons (Thunderwave, Purity, Sunrise, Cirrus), best armor sets by zone, Spirit Stone combos, and upgrade rules."
category: "Reference"
version: "1.0.6"
updated: "2026-08-09"
...
## How Equipment Works (30 Seconds)

- **Weapons**: Emma fights with a katana-style sword plus a ranged weapon (bow/crossbow). Swords roll **special effects** that trigger on parry, on hit, or under conditions.
- **Armor**: chest pieces mainly matter for **Spirit Stone slots**, **defense**, **elemental resistances**, and **awareness** (higher awareness = enemies spot you faster, hurting stealth).
- **Upgrades**: spend **Amber** at the Cleanse Walker Workbench. The upgrade cap is tied to the Walker's own upgrades — research the Walker regularly or weapon upgrades stall mid-game.
- **Spirit Stones** socket into both weapons and armor — they're the real stat engine. See the [Spirit Stones Guide](/guides/spirit-stones-guide) for the full list.
...
**Hunter's Sword** (poison buildup — the Poison build's backbone; from the Storyteller Golem in the Great Forest), **Fall Thunder**, **Spring Storm**, **Winterwake**, **Black Blossom**, **Camellia**.

### B-Tier

**Mechblade**, **Hazebringer** (acid/corrosion — best vs. Golems), **First Moon**, **Kanzashi**, **Silverlight**.

> **Rule of thumb**: match your sword's element to the boss's weakness. The four status weapons are Thunderwave (Lightning/Shock), Hunter's Sword (Poison), Hazebringer (Acid), and Sunrise Sword (Flame) — covering every Nushi weakness in the game.

### Ranged Weapons

- **Zangetsu Bow** — dropped by the Door Golem in Chapter 1; stronger and longer-ranged than the crossbow, slower. Carries the early game.
- **Crossbow** — faster fire rate, rapid-fire when holding the attack. Ammo types matter more than the weapon: Lightning, Poison, Flame, and Acid arrows/bolts are crafted from Manuals found in the world.
...
## Best Spirit Stones to Pair (Quick Picks)

- **Entanglement Stone** — start combat with 3 FP and 3 Entanglement, letting you spam Bloom Arts immediately. The best opener stone.
...
| Build | Sword | Armor | Stones | Koo side |
|-------|-------|-------|--------|----------|
| **Thunderwave (Shock)** | Thunderwave +3 | Insulating Mail | Entanglement Stone, Onslaught, Fluorescent Recovery | ATK Charm III with Lightning; Bolt Shard |
| **Poison** | Hunter's Sword | 6-slot armor (e.g., Floral Wraps → God Tree Guard) | Onslaught, Homing Shots | Dokuzeri: Fang + Status Effect Amp |
