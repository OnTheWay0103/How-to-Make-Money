...
## Boss Tier List — Nushi & Malefact

Every Nushi is fought at least twice — rematches add a second phase with a **fully restored health bar**. Treat the first emptied bar as the halfway point.

| Tier | Boss | Chapter | Weak To | Why This Tier |
|------|------|---------|---------|---------------|
| **S** | Corvus (Lv. 38) | 7 — Root Rot | Shock | Two-phase rematch with summoned corvid adds and Acid puddle control. Drops the Nushi Skill: Acid Burst — the only Koo Acid Art. |
...
- **S-Tier** bosses gate key progression rewards (Acid Burst, Charging Botan) and demand mastery of every combat system: parrying, unblockable tells, elemental counters, and add control.
- **A-Tier** bosses are the difficulty gatekeepers of the early game — beat them and the combat system clicks.
- **B-Tier** bosses teach status management and element matching.
- **Pending** bosses are verified as existing (via story-order reports) but no outlet has published complete attack data yet. Check back after the first post-launch guide wave.

---

## Best Early Skills Tier List

Shared skill points mean early picks matter — respecs need purification items.
...
| **A** | Healing Bouquet | Koo | AoE healing; vital before you have reliable potions. |
| **A** | Taunt | Koo (Pounce) | Draws aggro so Emma can heal, position, or land combos. |
| **B** | Helm Splitter | Emma | Aerial AoE slam — dodges ground attacks and builds the Down Gauge. |
| **B** | Petal Barrage | Emma | Strong targeted midair AoE; pair with a Koo attack for max damage. |
| **B** | Higanbana Roots | Koo | Groups enemies and applies Bind — great interruption tool. |
| **C** | Cloaking Grass | Emma | Stealth for executions — strong in niche situations, weak in boss fights. |
| **C** | Tracking Shot | Emma | Requires 7 Florescence — strong later, wasted early. |

---

## Best Builds Tier List (Launch Patch)

| Tier | Build | Core Pieces | Best Against |
|------|-------|-------------|--------------|
| **S** | Shock Build | Fall Thunder / Thunderwave Sword + Lightning Arrows + Sakura: Javelin + Shock Charm | Bosses — Shock paralysis opens long punish windows |
| **A** | Acid Build | Hazebringer + Acid Arrows + Acid Burst (post-Ch. 7) | Armored enemies — Corrosion strips defenses |
| **A** | Poison Build | Hunter's Sword + Poison Arrows + Dokuzeri: Fang | Sustained damage — melts Nue Malefact |
| **B** | Stealth Build | Cloaking Grass + Bow + assassination upgrades | Regular zones — clears packs without combat |

Full loadouts for the Shock, Poison, and Acid builds are in the [Elemental Builds Guide](/guides/elemental-builds-guide).
