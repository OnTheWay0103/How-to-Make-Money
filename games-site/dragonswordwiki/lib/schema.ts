 ...
 *
 * Describes DragonSword: Awakening as a software application / video game so
...
export function videoGameSchema(): Record<string, unknown> {
  return {
    ...
    description: 'An anime open-world action RPG with 19 playable heroes, tag-team combat, and no gacha. Buy-to-play on Steam.',
    url: 'https://store.steampowered.com/app/3065190/DragonSword_Awakening/',
    applicationCategory: 'Game',
    operatingSystem: 'Windows',
    genre: ['Action RPG', 'Open World', 'Anime', 'Single-Player', 'Co-op'],
    author: {
      '@type': 'Organization',
      name: 'Hound13',
    },
 ...
 * @example
 *   faqPageSchema([
 *     { question: 'Is DragonSword: Awakening free?', answer: 'No, it is a buy-to-play game on Steam.' },
