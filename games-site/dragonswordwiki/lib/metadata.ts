/**
 * Next.js Metadata API helpers for DragonSword Wiki.
 *
 ...
 *
 * - title uses a template so child pages produce `Page Name · DragonSword Wiki`
...
export const defaultMetadata: Metadata = {
  ...
  keywords: [
    ...
    'DragonSword wiki',
    'DragonSword Awakening guide',
    'DragonSword Awakening tier list',
    'DragonSword Awakening heroes',
    'DragonSword Awakening builds',
    'DragonSword Awakening beginner guide',
    'DragonSword Awakening combat guide',
    'DragonSword Awakening bosses',
  ],
