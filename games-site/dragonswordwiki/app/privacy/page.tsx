...
export const metadata: Metadata = {
  ...
  description: 'Privacy Policy for DragonSword Wiki — how we collect, use, and protect your data.',
};
...
export default function PrivacyPage() {
  return (
    <div className="max-w-3xl mx-auto px-4 py-12 prose prose-invert">
      ...
      <p>
        DragonSword Wiki ("we," "our," or "us") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, and safeguard your information when you visit our website at <strong>dragonswordwiki.vercel.app</strong>.
      </p>
