...
const FAQ_ITEMS = [
  ...
  { question: 'Is DragonSword: Awakening free-to-play or buy-to-play?', answer: 'Buy-to-play — $29.99 once ($44.98 Deluxe Edition). No gacha, no microtransactions for power, no season pass. All 19 heroes are unlocked through gameplay. Four more free heroes are coming in post-launch updates.' },
  ...
  { question: 'What platforms is it on?', answer: 'PC via Steam at launch. PlayStation and Nintendo versions are officially underway (a PS5 port has been reported); release dates are TBD. Xbox has not been announced.' },
  ...
  { question: 'What are the PC system requirements?', answer: 'Confirmed minimum: Windows 10, Intel Core i5-9400F, 8 GB RAM, NVIDIA GTX 1660, DirectX 12, and ~60 GB of storage (SSD recommended). Recommended specs have not been officially published.' },
  { question: 'Who developed DragonSword: Awakening?', answer: 'Developed and published by HOUND13, a South Korean studio best known for the action RPG Hundred Soul. The western Awakening version was redesigned from the original Korean release to remove gacha and microtransactions.' },
