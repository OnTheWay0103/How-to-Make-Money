...
export const metadata: Metadata = {
  title: 'All Guides',
  description:
    'Complete DragonSword: Awakening guide collection — hero builds, tier lists, combat strategies, boss fights, familiar guides, and endgame tips.',
};
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-12">
      ...
      <p className="text-gray-400 mb-8">
        {guides.length} guides covering every aspect of DragonSword: Awakening.
      </p>
