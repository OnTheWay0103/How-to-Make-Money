...
description: "How exploration works in Lunarium: the four real regions (Firleaves, Cyanstone, White Reef Isles, Paradise), benches, Nihilus-blocked paths, Astral Shards, embroidery blueprints, verified secrets, and where the hidden content hides."
category: "Guides"
version: "1.0"
updated: "2026-08-01"
keywords:
...
This guide covers the real structure of the game, where to look for hidden content, and which rumored secrets are verified.
...
## 5. Verified Secrets & Hidden Content

### 5.1 Embroidery Blueprint (First Confirmed Chest)
...
### 5.2 Astral Shards (Resonance Cap)
...
### 5.3 Optional Boss: Rearguard Warrior
...
### 5.5 The Dreamsingers' Hidden Laboratory
...
### 5.6 The Risen Longhorn Troll (Scripted Rematch)
...
### 5.7 Story-Gated Side Routes (Community Reported)
...
## 6. Honest Answers to Common Secret Questions
...
Some "secrets" guides circulating online are fabricated. Red flags:
