...
export const metadata: Metadata = {
  title: 'All Guides',
  description:
    'Complete Lunarium guide collection — builds, combat, boss strategies, walkthroughs, skill trees, equipment, endings, and more.',
};
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-12">
      ...
      <p className="text-gray-400 mb-8">
        {guides.length} guides covering every aspect of Lunarium.
      </p>
