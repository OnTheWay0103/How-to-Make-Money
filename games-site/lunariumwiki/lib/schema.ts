 ...
 *
 * Describes Lunarium as a software application / video game so
...
export function videoGameSchema(): Record<string, unknown> {
  return {
    ...
    name: 'Lunarium',
    description:
      'A hand-drawn isometric action RPG following Ave and Lune through a dying world. Master parry-based combat, unlock skill trees, equip charms, and discover two distinct endings.',
    url: 'https://store.steampowered.com/app/2939790/Lunarium/',
    applicationCategory: 'Game',
    operatingSystem: 'Windows',
    genre: ['Action RPG', 'RPG', 'Fantasy', 'Isometric', 'Hand-Drawn'],
    author: {
      '@type': 'Organization',
      name: 'Lunarium Game Studio',
    },
    publisher: {
      '@type': 'Organization',
      name: 'Imperfect Games',
    },
    offers: {
      '@type': 'Offer',
      price: '17.99',
