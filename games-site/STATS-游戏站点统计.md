...
| 11 | Tears of Metal | 7/23 | 32 | tearsofmetalwiki.vercel.app | ✅ | ✅ | ✅ | 8/1 反馈驱动 +3 新 +2 纠错（英雄名校准）；8/1 内容配比 +5（Wallace/Brienne/Ruadh 独立 Build 页、Corruption 机制、装备指南）+ 修复旧英雄/Boss 名残留；8/30 EXPAND-008 反馈驱动扩充 +1（healing-guide 治疗与回血经济，QA 有条件 PASS 已部署）；9/3 EXPAND-015 反馈驱动扩充 +1（crash-launch-fix-guide，QA quick PASS 已部署）；9/11 SKIP（无 v0.15+）+ patch-notes 扩为完整版本表 v0.8→v0.14 + 官方路线图（标注 plan not shipped）+ 🔴 平台纠错 7 文件（非 Steam PC-only，7/22 首发即 Steam+MS Store+PC Game Pass 且互通），QA PASS 已部署 |
| 12 | Grain Rot | 7/24 | 30 | grainrotwiki.vercel.app | ✅ | ✅ | ✅ | 8/7 游戏上线；8/3 1.0 内容更新（全量内容清单、生物群系+2、wishlist 25万→250k）；8/31 EXPAND-009 反馈驱动扩充 +1（rot-debuff-guide，QA PASS 已部署）；9/3 EXPAND-016 反馈驱动扩充 +1（multiplayer-matchmaking-guide，QA quick PASS 已部署）；9/11 EXPAND-024 反馈驱动扩充 +1（patch-notes-guide，终结 4 连 SKIP）+ 事实纠错（v1.07 确已实装 public server browser）+ 页脚/Terms IP 归属修正，QA quick PASS 已部署 |
