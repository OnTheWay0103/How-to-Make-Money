/**
 * Next.js Metadata API helpers for Welcome to Elderfield Wiki.
 *
 ...
 *
 * - title uses a template so child pages produce `Page Name · Welcome to Elderfield Wiki`
...
export const defaultMetadata: Metadata = {
  ...
  keywords: [
    ...
    'Welcome to Elderfield wiki',
    'Welcome to Elderfield guide',
    'Welcome to Elderfield release date',
    'Welcome to Elderfield demo',
    'cosy horror game',
    'Welcome to Elderfield farming',
    'Welcome to Elderfield romance',
    'Welcome to Elderfield turn-based combat',
    'Welcome to Elderfield Kwalee',
    'Welcome to Elderfield Chris Cote',
    'Welcome to Elderfield Cozy Mode',
  ],
...
export interface GuideFrontmatter {
  ...
  keywords: string[];
  /** ISO‑8601 date of last content update (e.g. "2026-08-30") */
  updated: string;
