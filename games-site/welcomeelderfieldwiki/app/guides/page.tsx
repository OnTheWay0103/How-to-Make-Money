...
export const metadata: Metadata = {
  title: 'All Guides',
  description:
    'Complete Welcome to Elderfield guide collection — beginner, demo, farming, combat, mysteries, romance, difficulty modes, and release info for the cosy horror RPG by Chris Cote / Kwalee.',
};
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-12">
      ...
      <p className="text-gray-400 mb-8">
        {guides.length} guides covering every aspect of Welcome to Elderfield by Chris Cote / Kwalee.
      </p>
