 ...
 *
 * Describes Taival as a software application / video game so
...
export function videoGameSchema(): Record<string, unknown> {
  return {
    ...
    name: 'Taival',
    description:
      'A 1-4 player co-op adventure RPG set in a hand-crafted voxel world. Explore seamless biomes with your shapeshifting Henki companion, unlock creature forms, craft gear, build your home, and shape the story through group voting.',
    url: 'https://store.steampowered.com/app/3152750/Taival/',
    applicationCategory: 'Game',
    operatingSystem: 'Windows',
    genre: ['Adventure', 'RPG', 'Co-op', 'Open World', 'Crafting', 'Voxel'],
    author: {
      '@type': 'Organization',
      name: 'Bonobo Software',
    },
    publisher: {
      '@type': 'Organization',
 ...
 * @example
 *   faqPageSchema([
 *     { question: 'Is Taival free?', answer: 'No, it is a paid game on Steam Early Access.' },
