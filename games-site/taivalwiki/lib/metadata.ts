/**
 * Next.js Metadata API helpers for Taival Wiki.
 *
 ...
 *
 * - title uses a template so child pages produce `Page Name · Taival Wiki`
...
export const defaultMetadata: Metadata = {
  ...
  keywords: [
    ...
    'Taival guide',
    'Taival Henki',
    'Taival companion forms',
    'Taival beginner guide',
    'Taival co-op',
    'Taival crafting',
    'Taival bosses',
    'Taival biomes',
