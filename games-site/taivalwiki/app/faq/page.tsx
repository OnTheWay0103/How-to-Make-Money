...
const FAQ_ITEMS = [
  ...
  { question: 'Are there microtransactions?', answer: 'No. Taival is a premium game with no in-game microtransactions. The base game is ¥77 (~US$16) on Steam, with the price expected to rise as Early Access content ships.' },
