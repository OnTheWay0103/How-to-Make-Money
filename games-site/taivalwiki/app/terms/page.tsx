...
export const metadata: Metadata = {
  ...
  description: 'Terms of Service for Taival Wiki — conditions for using our website.',
};
...
export default function TermsPage() {
  return (
    <div className="max-w-3xl mx-auto px-4 py-12 prose prose-invert">
      ...
      <p>
        By accessing and using Taival Wiki (<strong>taivalwiki.vercel.app</strong>), you agree to be bound by these Terms of Service. If you do not agree, please do not use our website.
      </p>

      <h2>2. Description of Service</h2>
      <p>
        Taival Wiki is an unofficial fan-made guide and wiki website for the video game "Taival." We provide game guides, tips, strategies, and related information. We are not affiliated with, endorsed by, or connected to the game's developers or publishers.
      </p>

      <h2>3. Intellectual Property</h2>
      <p>
        All game-related names, images, trademarks, and content are the property of their respective owners (Mingle Games). Our original guide content, articles, and website design are protected by copyright. You may not reproduce, distribute, or create derivative works from our content without permission.
      </p>
      ...
      <p>
        Taival Wiki and its operators shall not be liable for any damages arising from the use or inability to use this website. This includes, but is not limited to, direct, indirect, incidental, or consequential damages.
      </p>
