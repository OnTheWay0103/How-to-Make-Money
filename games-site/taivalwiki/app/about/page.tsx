...
export default function AboutPage() {
  return (
    <div className="max-w-3xl mx-auto px-4 py-12 prose prose-invert">
      ...
      <h2>Who We Are</h2>
      <p>
        Taival Wiki is an <strong>unofficial fan-made resource</strong> dedicated to "Taival," the cooperative PvE extraction horror game developed by SpiritVale Studio and published by NACON.
      </p>
      <p>
