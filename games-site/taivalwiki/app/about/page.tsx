...
export const metadata: Metadata = {
  title: 'About Us',
  description: 'About Taival Wiki — an unofficial fan wiki providing game guides, tips, and strategies.',
};
...
export default function AboutPage() {
  return (
    <div className="max-w-3xl mx-auto px-4 py-12 prose prose-invert">
      ...
      <h2>Who We Are</h2>
      <p>
        Taival Wiki is an <strong>unofficial fan-made resource</strong> dedicated to "Taival," the Nordic-themed action RPG.
      </p>
      <p>
        We are a small team of passionate gamers who create comprehensive guides, strategies, and resources to help players master the game. Our mission is to be the most helpful and up-to-date guide resource for the Taival community.
      </p>
      ...
      <h2>Disclaimer</h2>
      <p>
        <strong>Taival Wiki is not affiliated with, endorsed by, or connected to the developers or publishers of Taival.</strong> All game-related trademarks, images, and content are the property of their respective owners. This site is an independent fan project created to support the game's community.
      </p>
    </div>
  );
}
