...
const FEATURED_GUIDES = [
  ...
  { title: 'Best Business Guide — What to Start', description: 'Compare all seven business types — food stalls, noodle bars, stim stores, bars, restaurants and nightclubs — and find the best business for your playstyle and budget.', slug: 'best-business-guide', category: 'Business', updated: '2026-08-07' },
  { title: 'How to Make Money Fast', description: 'Maximize your income: menu pricing, energy black-market arbitrage, market trends from the newspaper, weather-aware selling, and the best passive income strategies.', slug: 'money-making-guide', category: 'Money', updated: '2026-08-07' },
  { title: 'Business Management — Staff, Upgrades & Supply', description: 'Master the management interface: scheduling staff around rush hours, reorder thresholds, venue level upgrades, managers, and greenhouse supply chains.', slug: 'business-management-guide', category: 'Business', updated: '2026-08-07' },
...
const FAQ_ITEMS = [
  ...
  { question: 'How do I make money fast in Nivalis Nights?', answer: 'The core strategy is mastering your first noodle bar before expanding: watch your inventory, schedule staff around lunch and dinner rushes, set a signature dish, and reinvest profits into upgrades. Later, the energy black-market trade and high-margin nightclubs become the biggest earners. Check our Money-Making Guide for the full breakdown.' },
  ...
  return (
    <>
      ...
      <section className="relative py-20 md:py-28 px-4 text-center bg-gradient-to-b from-[#0a0f1e] to-[#0f0f23]">
        ...
        <p className="text-sm text-gray-600 mb-8">Launching September 29, 2026 — PC (Steam & Epic Games Store)</p>
