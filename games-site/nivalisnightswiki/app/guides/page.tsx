...
export const metadata: Metadata = {
  title: 'All Guides',
  description:
    'Complete Nivalis Nights guide collection — business guides, money-making strategies, NPC relationships, apartment customization, fishing, and beginner walkthroughs for the cyberpunk life sim.',
};
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-12">
      ...
      <p className="text-gray-400 mb-8">
        {guides.length} guides covering every aspect of Nivalis Nights.
</p>
