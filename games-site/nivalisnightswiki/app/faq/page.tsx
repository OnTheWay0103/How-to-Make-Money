...
const FAQ_ITEMS = [
  ...
  { question: 'Is Nivalis Nights multiplayer?', answer: 'No — Nivalis Nights is a single-player experience. The city of Nivalis is populated by more than 100 AI-driven citizens with their own schedules, and your relationships with them evolve through single-player interactions.' },
  ...
  { question: 'How long is Nivalis Nights?', answer: 'No official playtime estimate has been given yet. Given the scope — seven business types, 100+ NPCs, apartment customization, fishing, and a chess tournament — expect dozens of hours to build your empire and explore the city. We\'ll update this with verified estimates after launch.' },
