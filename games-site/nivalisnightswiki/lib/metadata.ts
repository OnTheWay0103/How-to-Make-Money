/**
 * Next.js Metadata API helpers for Nivalis Nights Wiki.
 *
 ...
 *
 * - title uses a template so child pages produce `Page Name · Nivalis Nights Wiki`
...
export const defaultMetadata: Metadata = {
  ...
  keywords: [
    ...
    'Nivalis Nights business',
    'Nivalis Nights money making',
    'Nivalis Nights beginner guide',
    'Nivalis Nights tips',
    'Nivalis Nights fishing',
    'Nivalis Nights release date',
    'Nivalis Nights NPCs',
  ],
...
export interface GuideFrontmatter {
  ...
  keywords: string[];
  /** ISO‑8601 date of last content update (e.g. "2026-08-07") */
  updated: string;
