---
title: "Dinoblade Multiplayer Status — Single-Player Only (No Co-op, No PvP)"
...
- **Summons are AI-controlled.** Defeated bosses fight alongside you as AI allies. They are not other players.
...
The complete game — the dry canyons, mist-shrouded jungles, the Alpha predators, the meteor finale — is a solo experience designed around the parry-and-posture loop. See the [Beginner Guide](/guides/beginner-guide).

### 2. Use the Summoning System

Defeating bosses lets you summon them as AI allies — the closest thing to "co-op play" in Dinoblade. Summons are a confirmed combat tool that takes pressure off in long fights. See the [Boss Guide](/guides/boss-guide).

### 3. Compete Indirectly via Boss Rush

**Boss Rush mode** (unlocked after the final boss) is the game's gauntlet. There's no verified leaderboard, but it gives you a measurable goal: beat your own best clear. Speedrunners and challenge runners treat it as the competitive venue. See the [Boss Guide](/guides/boss-guide).
...
- [Boss Guide](/guides/boss-guide) — Boss Rush, the confirmed endgame gauntlet
- [Soul Arts Guide](/guides/soul-arts-guide) — The progression system alongside summons
