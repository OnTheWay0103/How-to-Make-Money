...
export function videoGameSchema(): Record<string, unknown> {
  return {
    ...
    name: 'Dinoblade',
    description:
      'A dinosaur-themed Soulslike action RPG developed by Team Spino LLC. Wield weapons held in your dinosaur companion\'s mouth, battle prehistoric bosses, and explore a world of danger and discovery.',
    url: 'https://store.steampowered.com/app/312345/Dinoblade/',
