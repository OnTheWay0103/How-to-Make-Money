 ...
 *
 * Describes Dinoblade as a software application / video game so
...
export function videoGameSchema(): Record<string, unknown> {
  return {
    ...
    name: 'Dinoblade',
    description:
      'A dinosaur-themed Soulslike action RPG developed by Team Spino LLC. Play a young Spinosaurus wielding a colossal Great Sword between its teeth, fight weapon-wielding rival dinosaurs, and explore a handcrafted prehistoric world of canyons, jungles, frozen basins, and forgotten ruins.',
    url: 'https://store.steampowered.com/app/3440070/Dinoblade/',
    applicationCategory: 'Game',
    operatingSystem: 'Windows',
    genre: ['Action RPG', 'Soulslike', 'Dinosaurs', 'Adventure', 'Fantasy'],
    author: {
      '@type': 'Organization',
      name: 'Team Spino LLC',
    },
 ...
 * @example
 *   faqPageSchema([
 *     { question: 'Is Dinoblade free?', answer: 'No, it is a paid game on Steam.' },
 *     { question: 'Can I play solo?',   answer: 'Yes -- the game is single-player.' },
 *   ])
 */
