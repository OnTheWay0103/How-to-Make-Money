...
const FAQ_ITEMS = [
  ...
  { question: 'What are Tower Blessings?', answer: 'Tower Blessings are 47 unique, game-changing abilities hidden across the tower floors. Examples include Artemis Dive (evasion summons tracking arrows) and Chain Quake (shockwaves chain between enemies). Stacking multiple blessings creates powerful run-defining synergies.' },
  ...
  { question: 'How long is Phantom Tower?', answer: 'The tower has 100 floors in Climb Mode. Completing all 100 floors with one class takes roughly 5-10 hours [Unconfirmed] — no official playtime estimate has been published. Unlocking all classes, mastering all builds, collecting all 128 weapons and 47 blessings, and earning all achievements adds 40-60+ hours of content.' },
  { question: 'Is there a demo?', answer: 'Yes! A free demo is available on Steam. It lets you climb up to floor 40 in Climb Mode and try Survival Mode up to the Desert biome [Unconfirmed]. Progress saves locally and carries over to the full game.' },
  { question: 'What is the price?', answer: 'Phantom Tower is $12.99 (€12.99/£11.75) on Steam, with a 24% launch discount for the first two weeks. On mobile (Google Play), the game is free-to-play with ads and in-app purchases, including a paid \'Full Game Unlock\' (third-party tracked). The price will increase when the game leaves Early Access.' },
  ...
  { question: 'Are there microtransactions?', answer: 'On Steam, there are no microtransactions — all 8 classes and content are included with the purchase. The mobile version has in-app purchases (starter packs and a paid \'Full Game Unlock\') beyond the free Warrior class.' },
