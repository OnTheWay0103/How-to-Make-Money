...
export const metadata: Metadata = {
  title: 'About Us',
  description: 'About Phantom Tower Wiki — an unofficial fan wiki. Learn about our research standards, editorial process, and how we verify game information.',
};
...
export default function AboutPage() {
  return (
    <div className="max-w-3xl mx-auto px-4 py-12 prose prose-invert">
      ...
      <p>
        We research, organize, and verify game information to help players conquer the mysterious 100-floor tower, master elemental reactions, and forge permanent builds. Our mission is to be the most helpful and accurate guide resource for the Phantom Tower community.
      </p>

      <h2>What We Offer</h2>
      <ul>
        <li><strong>Game Guides:</strong> Beginner guides, class breakdowns, weapon deep-dives, elemental combos, and build strategies</li>
        <li><strong>Boss Strategies:</strong> Tactics for floor bosses and elite encounters</li>
        <li><strong>System Guides:</strong> Tower Blessings, the Soulbinder, Climb and Survival modes</li>
      ...
      <p>
        Phantom Tower is in Early Access, and many details (the unannounced classes, the unnamed blessings and reactions) are not officially documented. This site is deliberately strict about labeling what is confirmed, what is community-reported, and what is unverified. Each guide includes a <strong>Verification</strong> section showing when it was last checked and which sources were consulted. If you find information that is outdated or incorrect, please <a href="/contact">let us know</a>.
      </p>
      ...
      <h2>Disclaimer</h2>
      <p>
        <strong>Phantom Tower Wiki is not affiliated with, endorsed by, or connected to Horien Studio or any of their subsidiaries or affiliates.</strong> All game-related trademarks, images, and content are the property of their respective owners. This site is an independent fan project created to support the game's community.
      </p>
      <p>
