...
export const metadata: Metadata = {
  title: 'All Guides',
  description:
    'Complete Phantom Tower guide collection — class breakdowns, builds, weapons, elemental combos, boss strategies, blessings, progression tips, and more.',
};
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-12">
      ...
      <p className="text-gray-400 mb-8">
        {guides.length} guides covering every aspect of Phantom Tower.
      </p>
