/**
 * Next.js Metadata API helpers for Grain Rot Wiki.
 *
 ...
 *
 * - title uses a template so child pages produce `Page Name · Grain Rot Wiki`
...
export const defaultMetadata: Metadata = {
  ...
  keywords: [
    ...
    'Grain Rot guide',
    'Grain Rot vessels',
    'Grain Rot constructs',
    'Grain Rot enemies',
    'Grain Rot biomes',
    'Grain Rot beginner guide',
    'Grain Rot tips',
    'Grain Rot outpost',
    'Grain Rot extraction',
    'Grain Rot co-op',
    'Beck & Branch Games',
  ],
...
export interface GuideFrontmatter {
  ...
  keywords: string[];
  /** ISO‑8601 date of last content update (e.g. "2026-07-24") */
  updated: string;
