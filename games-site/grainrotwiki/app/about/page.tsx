...
export const metadata: Metadata = {
  title: 'About Us',
  description:
    'About Grain Rot Wiki — an unofficial fan wiki. Learn about our research standards, editorial process, and how we verify game information.',
};

export default function AboutPage() {
  return (
    <div className="max-w-3xl mx-auto px-4 py-12 prose prose-invert">
      <h1>About Grain Rot Wiki</h1>

      <h2>Who We Are</h2>
      <p>
        Grain Rot Wiki is an <strong>unofficial fan-made resource</strong> dedicated to "Grain Rot," the horror co-op extraction builder developed by Beck & Branch Games and published by Neem Interactive.
      </p>
      <p>
        We research, organize, and verify game information to help players survive the procedurally shifting underground ruins. Our mission is to be the most helpful and accurate guide resource for the Grain Rot community.
      </p>

      <h2>What We Offer</h2>
      <ul>
        <li><strong>Game Guides:</strong> Beginner guides, vessel and construct breakdowns, enemy bestiaries, and extraction strategies</li>
        <li><strong>Enemy Strategies:</strong> Tactics for the Corrupted, including the sound-and-movement detection model</li>
      ...
      <ul>
        <li><strong>Verification first:</strong> Numerical values (damage, stats, costs) are only included where they can be verified against official sources or consistent community consensus. Unverified figures are marked as such, not stated as fact</li>
      ...
      <h2>Disclaimer</h2>
      <p>
        <strong>Grain Rot Wiki is not affiliated with, endorsed by, or connected to Beck & Branch Games, Neem Interactive, or any of their subsidiaries or affiliates.</strong> All game-related trademarks, images, and content are the property of their respective owners. This site is an independent fan project created to support the game's community.
      </p>
      <p>
