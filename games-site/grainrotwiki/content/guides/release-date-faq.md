...
A **free demo** is available now on Steam (released June 12, 2026):

- 3 underground biomes
- 9 enemy types
- 20+ unlockable constructs
- Upgradeable Outpost rooms
- Dungeon modifiers
- Full co-op
...
### Is there voice chat?
The game's corruption system distorts voices — "Bodies warp. Voices distort. Emotes become…worse" — and Steam lists Online Co-op, but the specifics of built-in voice chat are unconfirmed.

### How long is a typical run?
No official statement. Runs are extraction-based; expect session lengths to depend on depth and team discipline. Unconfirmed numbers circulating online are speculation.
