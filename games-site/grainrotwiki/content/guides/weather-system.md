...
Grain Rot's weather starts on the surface — a **scorched wasteland where "everything burns."**

| Condition | Confirmed? | What It Does |
|-----------|------------|--------------|
...
## The Rot: The Deeper-You-Go Climate

The Rot is Grain Rot's true environmental system — a **depth-scaled hazard** that gets worse the deeper you descend:
...
- **Depth = Rot.** "The deeper you go, the worse the Rot becomes."
...
The Corrupted are corrupted vessels — the Rot's corruption is both the game's origin story and its enemy roster:

- They **react to sound, movement, and each other** — the environment turns your noise into threats.
- In deep layers, **voices distort** — the audio cues you rely on become unreliable.
- Fire hurts vessels **and** the Corrupted — the hazard cuts both ways.

**The environmental loop:** the deeper you go, the more the environment (Rot, sound, darkness) behaves like a storm system — worsening visibility, worsening audio, worsening odds.

## Dungeon Modifiers: The Run-to-Run "Weather"

The demo confirms **dungeon modifiers** — run modifiers that change how each descent plays. These are the closest thing to a forecast system:
...
## How to Prepare (Confirmed Strategies)

| Hazard | Preparation |
|--------|-------------|
| Fire (everywhere) | Vessel choice matters — bodies are flammable; keep escape routes open |
| Sound-based threats | The [Stealth & Sound Guide](/guides/stealth-sound-guide) covers noise discipline — the environment punishes loud play |
| Deep-layer Rot | Budget depth — know when the descent stops paying; see the [Extraction Guide](/guides/extraction-guide) |
| Run modifiers | Read them first, adapt the loadout, treat each run as a forecast |

**The golden environmental rule:** in a world where everything burns, the safest "weather" is a short, shallow, loud-but-fast run — and the most profitable is a deep, quiet, slow one. You pick the climate by the depth you choose.

## Related Guides

- [Game Mechanics & Systems Guide](/guides/game-mechanics-systems-guide) — the Rot, vessels, and sound systems in full
- [All Biomes Guide](/guides/all-biomes-guide) — the layers where the conditions change
- [Demo Guide](/guides/demo-guide) — what the demo teaches about the environment
- [Survival Tips](/guides/survival-tips) — staying alive in the burning depths
- [Extraction Guide](/guides/extraction-guide) — the run's end, where all conditions converge
