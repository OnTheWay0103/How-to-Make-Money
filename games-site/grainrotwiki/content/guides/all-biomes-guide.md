...
description: 'What we know about Grain Rot biomes: the 3 demo underground biomes, the 2 new 1.0 biomes, the Deep Layers, procedural shifting ruins, and which layer details are confirmed versus unverified.'
...
Grain Rot is a horror co-op extraction builder set in a scorched wasteland where "everything burns." The action takes place in **procedurally shifting underground ruins** reached by a cursed elevator. The full game launched on **August 7, 2026**; here is exactly what is confirmed about the game's biomes and layers — and what remains unverified.
...
- The **full 1.0 release added two new biomes** beyond the demo's three — confirmed in the publisher's launch announcement. The new biomes' names have not been published in official materials as of this writing; see the [Full Release Guide](/guides/full-release-guide) for the complete 1.0 addition list.
...
| 2 new biomes added at 1.0 | ✅ Confirmed (names unverified) |
| Biomes appear in a fixed order as you descend | ❓ Unverified — likely, not stated |
| Biome names (Shallows / Warrens / Depths) | ❓ Community coverage only |
| Specific layer numbers per biome | ❓ Unverified |
| Biome-specific loot tables | ❓ Unverified |
| Biome-specific enemy rosters | ❓ Unverified |
...
- The full game's deepest content (and any layer cap) is not officially documented as of this writing.
...
The plan for this page is simple: we are replacing the unverified rows above with verified biome names, layer counts, loot tables, and hazard details drawn from in-game testing as that data becomes available. In the meantime, the honest state of knowledge is: **3 demo biomes exist plus 2 more at 1.0, depth scales danger and reward, and every specific name or number is unverified until we can check it in-game.**

The demo is still the best free way to see the biome gameplay for yourself — see our [demo guide](/guides/demo-guide) for what it contains. If you want the big picture before your first descent, start with the [beginner guide](/guides/beginner-guide).
