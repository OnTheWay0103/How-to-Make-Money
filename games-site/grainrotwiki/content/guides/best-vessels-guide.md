...
- **You are a Living Spark surviving inside fragile wooden vessels** that "splinter, collapse, and catch fire."
- **You can possess and swap between vessels** — this is a listed feature.
- **When your vessel breaks, the Spark escapes.** You stay in the run, search for another host, and force your way back in "before you fade out completely."
- **Vessels have different abilities** — official copy references vessels "with different abilities" and the demo includes "possessable vessels."
- **Vessels are flammable** — the game is set in a wasteland "where everything burns." Fire hazards threaten your body directly.

That is the confirmed framework: durability (fragile by design), speed, abilities, and fire risk. Individual vessel names, stats, and unlock requirements are **not officially published** — any named list currently circulating is community speculation.
...
|----------|----------------|
| How many hits does it take to break? | Durability is the baseline survival stat |
| How fast does it move? | Speed = scavenging rate + extraction safety |
| What does its ability actually do? | Abilities define your playstyle |
| How does it handle fire? | Everything burns — fire risk is real |
| What does it cost to unlock? | Opportunity cost against other unlocks |

## How to Evaluate a Construct

- **Does it solve a real problem?** (damage, range, resource conversion, distraction)
- **Is it silent?** Sound discipline is confirmed core gameplay — quiet tools are premium.
- **Does it stack with your vessel?** A fragile vessel wants distance; a slow vessel wants speed.
- **What does it cost?** Unlock cost vs. value-per-run.

## Build Archetypes That Work (Framework Only)

These are playstyle frameworks grounded in confirmed mechanics, not named loadouts:

1. **The Grappler** — high durability, melee tools, holds corridors while teammates work. Matches the confirmed physics-driven brawling (dropkicks, furniture smashing).
2. **The Hauler** — maximum carry, spends runs smashing furniture and feeding Grinders. Matches the confirmed extraction economy.
