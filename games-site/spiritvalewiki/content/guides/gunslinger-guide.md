...
|-----------|------------|
| Best kiting in the game — few classes can pin you down | Ammo management — running dry mid-fight is a real problem |
| High mobility and poke damage | Lower burst than Wizard or Berserker |
| Safe farming: you outrange almost everything | Gear-dependent — weak if your pistols are stale |
| LUK-scaling crits scale well with the card system | Slower AoE clearing than Wizard or Summoner |

In the current EA meta the Gunslinger sits around **A-tier for PvP** (kite king, poke pressure) and **B-tier for PvE** (unique playstyle, strong kiting, but ammo/gear scarcity). EA balance changes weekly — treat that as a snapshot.
...
| Stat | Priority | Why |
|------|----------|-----|
| **DEX** | Primary | Ranged damage and accuracy — your core stat |
| **AGI** | Secondary | Attack speed for sustained pistol DPS uptime |
| **LUK** | Third | Crit rate and crit damage — Gunslinger is one of the few classes where LUK is worth real points |
| **VIT** | Buffer | Enough to survive a stray hit; kiting, not armor, is your defense |
...
|------|----------------|--------|
| Weapon | Dual pistols — keep them current (highest base damage you can find) | Drops, Player Market |
| Headgear | Any +accuracy or +crit helmet | Drops |
| Armor | Light armor with move speed — never heavy armor | Zone drops |
| Accessories | LUK and crit accessories | Drops, market |
| Card | Crit rate and crit damage cards | Card system |

**Honesty note:** there is no community-confirmed best-in-slot item list for the Gunslinger yet — the class pool is thin in EA. Until the wiki and community document the top pistols, the rule is simple: highest base damage wins, and crit affixes beat everything else.
...
- [Class Tier List](/guides/class-tier-list) — Gunslinger rankings
- [Advanced Classes Guide](/guides/advanced-classes-guide) — All advanced class unlock quests
