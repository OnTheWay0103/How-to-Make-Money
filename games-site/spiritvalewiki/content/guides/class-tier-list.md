...
| **S** | **Paladin** | Near-immortal, party utility, the #1 solo class (STR/VIT and self-healing) | Lower damage output |
...
Avoid Acolyte-path classes as your first character — their value is party support, and solo play is the roughest road (see the [Solo Guide](/guides/solo-guide)).

---

## The "Don't Copy Old Guides" Warning

SpiritVale rebalances aggressively — guides written earlier in Early Access can already be outdated, and a balance patch can move a class an entire tier overnight. When you see a build, check its date and the current state of the game. The [Update & Patch Notes](/guides/updates-patch-notes) page tracks balance changes.
...
- [Solo Guide](/guides/solo-guide) — Best solo classes + LFG
