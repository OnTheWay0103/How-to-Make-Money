...
| Mode | Format | Win Condition | Best For |
|------|--------|---------------|----------|
| 1v1 Duel Arena | Solo, enclosed map | First to 3 kills | Practice, matchup knowledge |
| 3v3 Team Arena | 3 players, small map | Round-based, first to 3 round wins | Ranked climbing, coordination |
| 6v6 Battle Arena | 6 players, large map | First to 100 points (kills + objectives) | Guild practice, big rewards |
...
Ranked play runs in 6-week seasons. Your rank resets each season, but cosmetic rewards accumulate permanently.

| Rank | Points Needed | Reward |
|------|---------------|--------|
| Bronze | 0 | Season title |
| Silver | 1,000 | Title + weapon skin |
| Gold | 2,500 | Title + armor skin |
| Platinum | 4,500 | Title + mount skin |
| Diamond | 7,000 | Title + exclusive aura |
| Legend | Top 100 server | Legend title + unique banner |
...
| Set | Stats | Token Cost |
|-----|-------|------------|
| Gladiator's Set | Player Damage +X%, Damage Reduction from Players +X% | 8,000 |
...
## 4. Current Arena Meta

| Tier | Class | Role in Arena |
|------|-------|---------------|
...
- **Shinobi** dominates 1v1 — counter them by keeping distance and saving CC for their reveal
- **Priest** dominates 3v3 — the team that kills the enemy Priest first wins; force the engagement on your terms
- **Wizard** dominates 6v6 point control — AoE zoning on capture points wins rounds before kills do
...
## Quick Climb Checklist

- [ ] Build a PvP loadout separate from PvE gear
- [ ] Learn one comp and stick to it (team synergy beats individual skill)
- [ ] Play 3v3 for ranked — the ladder values team wins most
- [ ] Spend Colosseum Tokens on Gladiator's Set first
- [ ] Save CC for the enemy Priest / Shinobi, never the tank
