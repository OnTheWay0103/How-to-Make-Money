...
## 1. Creating or Joining a Guild

### Creating a Guild
To found a guild, visit the Guild Registrar NPC in Vale's Rest (near the central fountain).
...
Once created, you are the Guild Master. You can appoint up to 3 Officers who can invite members and manage the guild hall.
...
## 2. Guild Hall Features

The Guild Hall is a shared instanced space that grows with your guild's level. It is accessible from any Guild Portal NPC in major towns.
...
## 3. Guild Quests and Contributions
...
- [Beginner Guide](/guides/beginner-guide) — First 5 hours walkthrough
