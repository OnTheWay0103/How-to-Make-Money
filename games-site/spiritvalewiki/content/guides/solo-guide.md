...
### Gear Independence
As a solo player, you cannot rely on party drops or hand-me-downs. You must craft:

1. **Craft your own gear** — Focus on Blacksmithing and Tailoring
2. **Farm your own cards** — Target specific monsters for card drops
3. **Use the Card Exchange** — Trade duplicates for cards you need
4. **Visit stalls** — Buy gear upgrades from other players (check Ironforge Outpost)

### Consumable Self-Reliance

| Consumable | How to Sustain |
|------------|----------------|
| Health Potions | Alchemy Station — farm Vale Blossoms |
| Mana Potions | Alchemy Station — farm Sunpetals |
| XP Potions | Alchemy Station — farm Emberweed (Soulfire Citadel) |
| Refine Stones | Daily boss rotation + mining |
| Card Removers | General Goods NPC — 500 gold each |
...
### Boss-Specific Solo Tips

| Boss | Solo Strategy |
|------|---------------|
| Forest Treant (12) | Easy — just avoid the green ground circles |
| Iron Boar King (18) | Strafe perpendicular to charge line |
| Queen Bee (22) | Bring anti-poison potions, kill adds quickly |
| Stoneback Golem (25) | Slow fight — don't get greedy, dodge all slams |
| Shadow Wolf Alpha (28) | Kill wolf adds immediately, then focus boss |
| Lava Elemental (32) | Constant movement — never stop walking |
| Frost Bear (35) | Stay behind at all times, watch for spin attack |
| Soulfire Guardian (43) | Space management — don't get cornered by fire |
| Void Mage (48) | Save dash for void zone pull, burst during cooldowns |
...
**Solo tip:** Grind in lower-density edges of popular maps rather than the center. The XP may be slightly slower, but you won't die.
