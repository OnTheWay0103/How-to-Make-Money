---
title: "SpiritVale Endgame Guide — Activities, Raids, and Progression"
...
Heroic difficulty dungeons are the first endgame activity you will encounter. They share the same maps as normal dungeons but feature enhanced enemy stats, new boss mechanics, and exclusive loot tables.
...
## 4. Gear Refinement System

Endgame gear can be refined to increase base stats and unlock bonus effects.

### 4.1 Refinement Tiers
...
## 5. Daily Endgame Loop

To maximize progression, structure your daily play around this priority list:

| Priority | Activity | Time Required | Reward |
|----------|----------|-------------|--------|
| 1 | Heroic Dungeons (3 runs) | 45 min | Seals + Stones |
| 2 | World Boss (if active) | 15 min | Epic gear chance |
| 3 | Weekly Raid Wing | 60 min | Raid Tokens |
| 4 | Refinement attempts | 10 min | Gear upgrades |
| 5 | Daily Quests | 20 min | Gold + Materials |
...
- [Builds Guide](/guides/builds-guide) — Optimized endgame builds by class
