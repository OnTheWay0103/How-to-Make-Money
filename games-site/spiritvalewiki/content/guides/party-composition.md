...
## 1. The Five Roles (and Which Advanced Classes Fill Them)

Every party role maps to one or more of the 8 advanced classes (unlocked at Job Level 50 — see the [Classes Guide](/guides/classes-guide)). Note that in the current EA build, classes can flex: a Paladin can off-tank *and* deal damage, and a Summoner contributes DPS plus a pet wall.
...
| DPS | Wizard, Gunslinger, Shinobi, Necromancer | Burst AoE, ranged safety, fast clear, and DoT sustain respectively |

**Community consensus on flexibility:** Paladin and Summoner are rated S-tier overall; Berserker is the easiest raw-damage pick. Acolyte-path classes are bottom-tier for solo play but their value is precisely here — in parties.
...
### 4-Player Dungeon Comp (Levels 25+)

| Slot | Class | Note |
|------|-------|------|
| Tank | Paladin | Pulls and holds every pack |
| Healer | Priest | Keeps the tank alive through double pulls |
...
Recommended: **1 Tank, 2 Healers, 3 DPS**. The Frost Oracle's ice storm phases and the Shadow Lich's corruption aura deal unavoidable damage — the second healer is what keeps the wipe count at zero.

### 8-Player Raid Comp (Tier 3: Void Kraken, Phoenix Sovereign)

Recommended: **2 Tanks, 2 Healers, 4 DPS** — one tank per phase mechanic (Void Kraken's tentacle aggro, Phoenix Sovereign's split adds), and both healers running their cooldowns in sequence rather than at once.
...
| Rule | Impact on Comp |
|------|----------------|
| Kill-steal rule | You cannot attack another party's mobs — crowded maps force you to group up, which is exactly what the game wants |
| Shared XP bonus | Grouping with same-level players is strictly faster than solo farming post-30 |
| No group finder | Comp flexibility matters — you often take what you get from Discord LFG, so classes that flex (Paladin, Summoner) are more valuable |
| Free server transfer | If your server's party pool is dead at your play hours, transfer (free, account-wide) rather than compromising your comp |
...
| Content | Size | Comp |
|---------|------|------|
| Dungeons (25-45) | 4 | 1 Tank / 1 Healer / 2 DPS (1 flex) |
| Tier 1 Raids (Stone Colossus, Corrupted Wyrm) | 4 | 1 Tank / 1 Healer / 2 DPS |
