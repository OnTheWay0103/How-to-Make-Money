...
## Advanced Class Unlock Overview

To unlock any advanced class, you must complete three requirements:
...
## All Advanced Class Options

### Evolution Tree

```
Knight    (Level 1) ──> Paladin      (J50)
...
|----------------|-------------------|------|--------|------------|
| Paladin | Knight | Tank / Support | Sword + Shield | Easy |
...
- 5,000 gold
- 50 Bone Fragments (drops from Undead Soldiers in Whisperwind Ruins)

### Quest Chain: "The Awakening of the Dead"

**Step 1 — Speak to Master Theron**
Location: Summoner's Guild, Vale's Rest.
Master Theron gives you the quest "The Awakening of the Dead." He will ask you to prove your understanding of death magic.
...
## Paladin Unlock Quest (Knight → Paladin)

Paladin is the second most popular advanced class and the best tank in the current meta.
...
**Step 1 — Speak to High Paladin Aldric**
Location: Cathedral of Light, Vale's Rest.
Aldric tasks you with proving your devotion through a trial of combat and faith.

**Step 2 — Purge the Undead at Whisperwind Ruins**
Kill 100 Undead Soldiers, 50 Undead Mages, and 25 Fallen Knights in Whisperwind Ruins. Each kill rewards 1 Purification Token. This step takes 30-45 minutes.

**Step 3 — Trial of the Light (Solo Instance)**
This is a survival gauntlet: survive 5 waves of increasing difficulty.
- Wave 1-2: Skeleton soldiers (easy)
- Wave 3-4: Skeleton mages + priests (priority target mages)
- Wave 5: Dark Knight boss + 4 adds

**Recommended setup:** Stack VIT and use Guard Stance. Bring HP regen food and the Endure skill. The key to Wave 5 is killing adds before focusing the boss.

**Step 4 — Receive Blessing**
Return to High Paladin Aldric. Unlock Paladin class.

### Paladin Skills Preview
...
## Other Advanced Class Unlock Quests
...
## Advanced Class Tier Ranking

### PvE (Dungeon / Raid)

| Tier | Advanced Class | Role | Why |
|------|----------------|------|-----|
| S | Paladin | Tank | Best mitigation, party saves |
...
## Which Advanced Class Should You Choose?
...
## Can You Change Advanced Classes Later?

Yes. The Waybinder NPC in any major town allows you to change between advanced classes, provided you have completed the unlock quest for each one.

- **Changing to an advanced class you've already unlocked:** Free, no cooldown.
- **Unlocking a new advanced class:** You must complete its quest chain and pay the fee again.
- **Switching back to base class:** Not possible after advancement. You are permanently an advanced class.

**Recommended strategy:** Unlock one advanced class per character. Use alt characters to experience other specializations.

---

## Related Guides

- [Classes Guide](/guides/classes-guide) — All 15 base and advanced classes reference
- [Class Leveling Guide](/guides/class-leveling-guide) — How to reach J50 fast
- [Class Tier List](/guides/class-tier-list) — PvE and PvP rankings
- [Builds Guide](/guides/builds-guide) — Recommended endgame builds
