 ...
 *
 * Describes Sephiria as a software application / video game so
...
export function videoGameSchema(): Record<string, unknown> {
  return {
    ...
    name: 'Sephiria',
    description:
      'A pixel-art action roguelite where you play as a rabbit warrior climbing the Tower of Sephiria. 6 weapons, 150+ relics, 4-player co-op, and a deep Inscription system. 94% positive on Steam.',
 ...
 * @example
 *   faqPageSchema([
 *     { question: 'Is Sephiria free?', answer: 'No, it is a paid game on Steam.' },
