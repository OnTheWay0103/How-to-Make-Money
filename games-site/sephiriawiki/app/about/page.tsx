...
export const metadata: Metadata = {
  title: 'About Us',
  description: 'About Sephiria Wiki — an unofficial fan wiki. Learn about our research standards, editorial process, and how we verify game information.',
};
...
export default function AboutPage() {
  return (
    <div className="max-w-3xl mx-auto px-4 py-12 prose prose-invert">
      ...
      <p>
        We research, organize, and verify game information to help players climb the Tower of Sephiria. Our mission is to be the most helpful and accurate guide resource for the Sephiria community.
      </p>

      <h2>What We Offer</h2>
      <ul>
        <li><strong>Game Guides:</strong> Beginner guides, weapon breakdowns, artifact catalogs, and build strategies</li>
        <li><strong>Boss Strategies:</strong> Detailed tactics for boss encounters, from Chapter 1 to the Chapter 6 finale</li>
      ...
      <ul>
        <li><strong>Verification first:</strong> Numerical values (counts, stats, requirements) are only included where they can be verified against official sources or consistent community consensus</li>
