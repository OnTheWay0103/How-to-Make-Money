...
description: "The ultimate community wiki for Sephiria — the pixel-art action roguelite by TEAM HORAY. Climb the Tower of Sephiria with 6 weapons, ~300 artifacts, and 1-4 player co-op. Find weapon guides, boss strategies, build guides, secret rooms, and more."
category: "Home"
version: "1.0"
updated: "2026-08-11"
...
related: ["beginner-guide", "full-release-guide", "weapons-guide", "boss-guide", "builds-guide"]
---
...
| [Weapons Guide](/guides/weapons-guide) | All 6 weapons & upgrades | Starter |
| [Builds Guide](/guides/builds-guide) | Weapon & artifact synergies | Intermediate |
| [Artifacts Guide](/guides/artifacts-guide) | ~300 artifact catalog | Intermediate |
| [Boss Guide](/guides/boss-guide) | All 10+ boss strategies | Intermediate |
...
| [Price Increase & Is It Worth It](/guides/price-increase-and-worth-it-guide) | The September 14 price rise & buying decision | Starter |
...
### Full Release Guide
Sephiria 1.0 is live! The final Chapter 6 ending, new upgrade lines for all 6 weapons, Hard Mode extended to level 60, the Side Bag, and more — all in one place. [Read the launch guide →](/guides/full-release-guide)

### Weapons Guide
All 6 weapons — Sword & Shield, Greatsword, Dagger, Katana, Crossbow and Staff — their upgrade branches, mastery perks, and which one suits your playstyle. [Read the weapons guide →](/guides/weapons-guide)

### Endgame Guide
Hard Mode → artifacts and masteries. The complete post-launch progression ladder. [Plan your endgame →](/guides/endgame-guide)
...
Sephiria is a **pixel-art action roguelite** developed by TEAM HORAY (the Dungreed studio). You play as a rabbit warrior climbing the **Tower of Sephiria** through 6 procedurally-arranged chapters against 10+ bosses. The game supports **1-4 player online co-op** and launched at 1.0 on July 31, 2026 after 484 days of Early Access (April 2025 → July 2026).

Each run is a fresh climb: choose from 6 weapons, collect artifacts, socket inscriptions, defeat the chapter boss, and die or reach the top. Death is part of the loop — permanent progression (talents, inscriptions, artifacts, weapon mastery) makes every run count.

---

## Key Systems at a Glance

- **6 Weapons** — Sword & Shield, Greatsword, Dagger, Katana, Crossbow & Staff (200+ upgrades in 1.0)
- **6 Chapters** — The story ends at Chapter 6 with a proper ending
- **~300 Artifacts** — Per-run passive items with deep synergies
- **Talents & Inscriptions** — Permanent progression systems
