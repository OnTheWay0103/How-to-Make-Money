...
**Both.** You can play solo or in online co-op with up to 4 players. The game scales enemy health and damage based on player count — solo play is fully balanced and viable.
...
**No.** Sephiria supports online co-op only. There is no split-screen or local multiplayer.
...
Yes, a **free demo** is available on Steam. The demo includes the first chapter (The Rooted Depths) and gives you a solid introduction to the core gameplay loop. Progress does not carry over to the full game.
...
- [Beginner's Guide](/guides/beginner-guide) — Getting started with Sephiria
- [Weapons Guide](/guides/weapons-guide) — All 6 weapons explained
- [Co-op Guide](/guides/coop-guide) — Multiplayer team strategies
- [Solo Guide](/guides/solo-guide) — Tips for playing alone
- [Inscriptions Guide](/guides/inscriptions-guide) — Permanent progression system
