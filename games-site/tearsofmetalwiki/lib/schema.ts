 ...
 *
 * Describes Tears of Metal as a software application / video game so
...
export function videoGameSchema(): Record<string, unknown> {
  return {
    ...
    name: 'Tears of Metal',
    description:
      'A Scottish action roguelike hack-and-slash with 4-player co-op. Build a village, forge legendary weapons, collect emblems, and fight through procedurally generated expeditions to restore peace to the war-torn highlands. Published by Paper Cult.',
    url: 'https://store.steampowered.com/app/tears-of-metal',
    applicationCategory: 'Game',
    operatingSystem: 'Windows',
    genre: ['Action Roguelike', 'Hack-and-Slash', 'Co-op', 'RPG'],
    author: {
      '@type': 'Organization',
      name: 'Paper Cult',
    },
 ...
 * @example
 *   faqPageSchema([
 *     { question: 'Is Tears of Metal free?', answer: 'No, it is a paid game on Steam.' },
 *     { question: 'Can I play solo?',   answer: 'Yes — all heroes are viable solo.' },
 *   ])
 */
