/**
 * Next.js Metadata API helpers for Tears of Metal Wiki.
 *
 ...
 *
 * - title uses a template so child pages produce `Page Name · Tears of Metal Wiki`
...
export const defaultMetadata: Metadata = {
  ...
  keywords: [
    'Tears of Metal',
    'Tears of Metal wiki',
    'Tears of Metal guide',
    'Tears of Metal builds',
    'Tears of Metal beginner guide',
    'Tears of Metal boss guide',
    'Tears of Metal co-op',
    'Paper Cult',
    'action roguelike',
  ],
