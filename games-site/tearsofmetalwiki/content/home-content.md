...
| [Wallace Build Guide](/guides/wallace-build-guide) | Longsword all-rounder | Intermediate |
| [Brienne Build Guide](/guides/brienne-build-guide) | Unarmed speedster | Advanced |
| [Ruadh Stonecrusher Build Guide](/guides/ruadh-build-guide) | Hammer stagger machine | Advanced |
| [Equipment Guide](/guides/equipment-guide) | Armor, gear & stat priority | Intermediate |
| [Corruption Guide](/guides/corruption-guide) | Act 3's core mechanic | Advanced |
...
| [Low FPS & Stutter Fix](/guides/low-fps-fix-guide) | PC performance in big battles | Fixes |
...
| [Armor & Shield Break Guide](/guides/armor-break-guide) | Armored enemies & grey bars | Intermediate |
| [Healing Guide](/guides/healing-guide) | Recovery & coin budgeting | Intermediate |
| [Co-op Revive Guide](/guides/co-op-revive-guide) | Health-cost revive rules (v0.12) | Intermediate |
| [Emblem & Artifact Guide](/guides/emblem-artifact-guide) | Synergy systems | Advanced |
| [Charms Guide](/guides/charms-guide) | Charm stacking, tiers & coin split | Intermediate |
...
### Best Builds
Three optimized builds covering Wallace, Brienne, and Ruadh Stonecrusher — with emblem combinations, artifact choices, and co-op synergy tips. [View builds ->](/guides/best-builds)

### Hero Build Guides
Deep dives on each launch hero: [Wallace (longsword)](/guides/wallace-build-guide), [Brienne (unarmed)](/guides/brienne-build-guide), and [Ruadh Stonecrusher (giant hammer)](/guides/ruadh-build-guide) — weapons, emblems, artifacts, and playstyle.
...
- **Corruption** — Act 3 zones drain health; Corruption Resist is mandatory late game
- **Recommended Co-op Comp** — 1 Wallace + 1 Ruadh + 1 Brienne + 1 flex
