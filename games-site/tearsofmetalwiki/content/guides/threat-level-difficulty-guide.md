...
3. **One missed block/parry/dodge = half your HP** — a captain combo hits for enormous chunks when your defense fails.
4. **Threat Level compounds it** — if you cleared aggressively through regions 1–2, The Scar's escalation starts high.

### How to Survive The Scar

| Rule | Why |
|------|-----|
| **Don't full-clear the map** | Skip optional groups once the objective is met — keeps Threat Level down |
...
## The Healing Economy (Why Pots Are Precious)
...
## Route Planning (The Anti-Threat Checklist)
...
**Q: Is the difficulty spike a bug?**
No — it's the Threat Level system, confirmed by media testing. It's just poorly explained in-game.

**Q: Should I clear every map?**
Only if you want the challenge. For progression, clear the objective and leave.

**Q: Why do I die so fast in The Scar?**
Elite density + no healing + your accumulated Threat Level. Fix the first two with route planning; the third by not full-clearing regions 1–2.

**Q: Does difficulty scale with party size?**
Yes, to a degree — co-op spreads the Threat Level burden (more players = more total clear power), which is one reason 4-player runs feel easier than solo (see the [Co-op Guide](/guides/co-op-guide)).

**Q: Where do I get more healing?**
Buy from the village between campaigns and loot caches. Never enter a boss fight below full HP — a full-health run is worth more than any cache you skipped.

---

## Related Guides

- [Beginner Guide](/guides/beginner-guide) — first-run habits that keep Threat Level low
- [Heroes Tier List](/guides/heroes-tier-list) — Wallace's forgiving defense for learning the system
- [Save System Guide](/guides/save-system-guide) — what you keep when you quit a brutal run
- [Boss Guide](/guides/boss-guide) — Gilles the Hog, Iseult the Banshee
- [Co-op Guide](/guides/co-op-guide) — how parties change the difficulty math
