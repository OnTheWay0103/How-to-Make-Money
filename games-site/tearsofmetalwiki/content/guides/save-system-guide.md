...
| Question | Answer |
|----------|--------|
| Mid-campaign saves? | **No** — campaigns are all-or-nothing, 1–2 hours per run |
...
- **What it doesn't do (yet):** it does not create mid-campaign checkpoints — a clean quit still ends the run.

**If you suspect your save corrupted:** verify game files (Steam: Properties → Installed Files → Verify integrity), then launch — the recovery system should rebuild your last good state.

---

## Why Mid-Campaign Saves Don't Exist Yet
...
## Planning Around the 1–2 Hour All-or-Nothing Run

Until mid-campaign saves land, treat every campaign as a commitment:

| Tip | Detail |
|-----|--------|
| **Block the time** | A campaign is 1–2 hours; start only when you can finish |
| **Boss runs ≠ farming runs** | Decided what you want: if you're grinding meta progress, a run you quit early is fine; if you're boss-rushing, budget the full time |
| **Play co-op for bailouts** | In a party, a friend's run can carry your session — and failure is shared rather than solo-salt (see [Co-op Guide](/guides/co-op-guide)) |
| **Abandon gracefully** | If a run is doomed (see the [Threat Level Guide](/guides/threat-level-difficulty-guide)), end it before the boss — the meta progress you banked is still yours |
| **Watch for the patch** | Mid-campaign saves are the top priority — the [Patch Notes](/guides/patch-notes) page announces them the day they land |

---

## FAQ

**Q: Can I save mid-run in Tears of Metal?**
Not yet. Mid-campaign saves are confirmed as the #1 player request and top developer priority, but no release date.

**Q: Will I lose everything if I quit?**
...
**Q: Is save-scumming possible?**
No — and that's precisely why the devs are reworking meta progression before enabling mid-run saves.

---

## Related Guides

- [Threat Level & Difficulty Guide](/guides/threat-level-difficulty-guide) — plan routes so runs are worth their 1–2 hours
- [Progression Walkthrough](/guides/progression-walkthrough) — what persists between runs
- [Patch Notes & Roadmap](/guides/patch-notes) — mid-campaign save announcement tracker
- [Beginner Guide](/guides/beginner-guide) — first-run expectations
