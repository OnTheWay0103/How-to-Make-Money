...
# Delverium Crafting Recipes Chart

Crafting is one of the pillars of Delverium's core loop: **gather resources → build shelters → farm → recruit and trade with NPCs → craft items (food, tools, weapons, armor, building materials) → descend into dangerous dungeons**. Because Delverium is still in Early Access development, Sagestone Games has confirmed the crafting **categories** but has not published specific recipes. This page is the quick-scan reference for what we know — and what we don't.

## Confirmed Crafting Categories

| Category | What it covers | Confirmed status |
|---|---|---|
| **Food** | Meals made by cooking; supports survival and dungeon runs | ✅ Confirmed (core loop; farming + cooking in Feb 2026 demo update) |
| **Tools** | Items for gathering, mining, farming and building | ✅ Confirmed (core loop: "craft items — food, tools, weapons…") |
| **Weapons** | Combat equipment for dungeon fights | ✅ Confirmed (core loop: "weapons"; dungeon combat confirmed) |
...
|---|---|
| Crafting categories (food, tools, weapons, armor, building materials) | ✅ Confirmed |
| Farming system — till soil, plant seeds, water crops, breed animals, fish, cook | ✅ Confirmed (Feb 2026 demo update) |
...
- Station names (workbench, furnace, anvil, etc. — **all unconfirmed**)
- How stations are unlocked or placed
- Whether stations are upgradeable

Treat any station list found in older guides as unverified. This section will be filled in at EA launch (Sept 22, 2026) and after the first EA content updates.

## Material Sources (Confirmed)

| Source | What you get (confirmed wording) | Notes |
|---|---|---|
| Mining | Ores | "Mine ores" — part of the confirmed world description |
| Exploration | Rare materials | "Collect rare materials" from the procedurally generated world |
| Dungeons | Unique items | "Loot unique items" — dungeon rewards are a confirmed loot source |
| Farming | Food ingredients | Till soil, plant seeds, water crops, breed animals, fish, cook (Feb 2026 demo update) |
| NPCs | Trade goods | Recruit and trade with NPCs (core loop) |
...
This page will be rewritten the moment recipes are playable in Early Access. Bookmark it and check back after **September 22, 2026** for:

- Complete recipe lists by category
- Crafting station names and requirements
