...
export function videoGameSchema(): Record<string, unknown> {
  return {
    ...
    name: 'Delverium',
    description:
      'A 1-8 player co-op survival sandbox RPG. Explore a procedurally generated world, gather resources, build shelters, farm, craft, and descend into dangerous dungeons. Launching in Steam Early Access on September 22, 2026.',
    url: 'https://store.steampowered.com/app/2710040/Delverium/',
    applicationCategory: 'Game',
    operatingSystem: 'Windows',
    genre: ['Survival', 'Sandbox', 'Co-op', 'Crafting', 'Open World', 'RPG'],
    author: {
      '@type': 'Organization',
      name: 'Sagestone Games',
    },
    publisher: {
      '@type': 'Organization',
      name: 'Sagestone Games',
