...
export const metadata: Metadata = {
  title: 'About Us',
  description: 'About Delverium Wiki — an unofficial fan wiki. Learn about our research standards, editorial process, and how we verify game information.',
};
...
export default function AboutPage() {
  return (
    <div className="max-w-3xl mx-auto px-4 py-12 prose prose-invert">
      ...
      <h2>Who We Are</h2>
      <p>
        Delverium Wiki is an <strong>unofficial fan-made resource</strong> dedicated to "Delverium," the 1-8 player co-op survival sandbox RPG developed by Sagestone Games.
      </p>
      <p>
        We research, organize, and verify game information to help players explore, build, farm, craft, and fight their way through Delverium's procedurally generated world. Our mission is to be the most helpful and accurate guide resource for the Delverium community.
      </p>

      <h2>What We Offer</h2>
      <ul>
        <li><strong>Game Guides:</strong> Beginner guides, demo coverage, co-op setup, crafting references, and build guides</li>
        <li><strong>System Guides:</strong> Biomes, dungeons, NPC trading, farming, and split-screen multiplayer</li>
        <li><strong>Update Coverage:</strong> Pre-release information organized around the confirmed Early Access launch</li>
      ...
      <p>
        Delverium is pre-release — it launches into Early Access on September 22, 2026, and many systems are not yet publicly detailed. This site is deliberately strict about labeling what is confirmed, what is community-reported, and what is unverified. Each guide includes a <strong>Verification</strong> section showing when it was last checked and which sources were consulted. If you find information that is outdated or incorrect, please <a href="/contact">let us know</a>.
      </p>
      ...
      <h2>Disclaimer</h2>
      <p>
        <strong>Delverium Wiki is not affiliated with, endorsed by, or connected to Sagestone Games or any of their subsidiaries or affiliates.</strong> All game-related trademarks, images, and content are the property of their respective owners. This site is an independent fan project created to support the game's community.
      </p>
      <p>
