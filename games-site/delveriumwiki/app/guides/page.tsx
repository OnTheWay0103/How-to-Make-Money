...
export const metadata: Metadata = {
  title: 'All Guides',
  description:
    'Complete Delverium guide collection — release info, demo guide, co-op multiplayer, crafting recipes, builds, dungeons and bosses.',
};
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-12">
      ...
      <p className="text-gray-400 mb-8">
        {guides.length} guides covering every aspect of Delverium.
      </p>
