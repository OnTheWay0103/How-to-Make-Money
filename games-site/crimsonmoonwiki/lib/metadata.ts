/**
 * Next.js Metadata API helpers for Crimson Moon Wiki.
 *
 ...
 *
 * - title uses a template so child pages produce `Page Name · Crimson Moon Wiki`
...
export const defaultMetadata: Metadata = {
  ...
  keywords: [
    ...
    'Crimson Moon wiki',
    'Crimson Moon guide',
    'Crimson Moon ProbablyMonsters',
    'Crimson Moon Gildenarch',
    'Crimson Moon co-op',
    'Crimson Moon builds',
    'Crimson Moon Incursions',
    'Crimson Moon Dead Gods',
    'Crimson Moon Boons',
    'Crimson Moon Weapon Arts',
  ],
...
export interface GuideFrontmatter {
  ...
  keywords: string[];
  /** ISO‑8601 date of last content update (e.g. "2026-08-28") */
  updated: string;
