...
export function videoGameSchema(): Record<string, unknown> {
  return {
    ...
    name: 'Crimson Moon',
    description:
      'A soulslike action RPG by ProbablyMonsters set in the fallen gothic city of Gildenarch. Fight through three Wards, defeat the world bosses, purify gear in Incursions, and take on the Dead Gods — solo or in 2-player co-op.',
    url: 'https://store.steampowered.com/app/4317690/Crimson_Moon/',
    applicationCategory: 'Game',
    operatingSystem: 'Windows',
    genre: ['Action RPG', 'Soulslike', 'Co-op', 'Roguelike', 'Fantasy'],
    author: {
      '@type': 'Organization',
