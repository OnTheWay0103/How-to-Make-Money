...
export const metadata: Metadata = {
  title: 'All Guides',
  description:
    'Complete Crimson Moon guide collection — co-op, builds, Boons, Weapon Arts, Incursions, Dead Gods bosses, purification, and beginner guides for the ProbablyMonsters soulslike.',
};
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-12">
      ...
      <p className="text-gray-400 mb-8">
        {guides.length} guides covering every aspect of Crimson Moon by ProbablyMonsters.
      </p>
