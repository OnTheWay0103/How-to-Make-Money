...
export const metadata: Metadata = {
  title: 'All Guides',
  description:
    'Complete Witchspire guide collection — beginner tips, class builds, familiar locations, boss strategies, crafting recipes, and more.',
};
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-12">
      ...
      <p className="text-gray-400 mb-8">
        {guides.length} guides covering every aspect of Witchspire.
      </p>
