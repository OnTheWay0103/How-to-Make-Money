...
The creation screen has three sections, completed in order:

1. **Visual Customization** — appearance only, no stat impact
...
## Section 1: Visual Customization

Visual options are purely cosmetic. None affect gameplay or stats.

| Option | Choices Available | Notes |
|--------|------------------|-------|
| Body Type | 2 types (A and B) | Slight, lean builds — stereotypical magic-user physique |
...
**Pro tip:** Your Coven choice will layer an outfit and color scheme on top of your character. Preview how your face and hair look with each Coven's outfit before finalizing.

---

## Section 2: Coven Selection

This is the most impactful decision in character creation. Your Coven determines your starting weapon, magic school, and armor appearance.
...
- [All Familiars Guide: Full Database](/guides/all-familiars-guide)
