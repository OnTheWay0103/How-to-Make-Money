...
**Solo:**
1. Let your familiar engage first to draw initial aggro
2. Stay at mid-range (not close, not far) to bait Sand Slashes
3. After each Sand Slash, move in for 2-3 hits, then back off
4. When Burrow happens, stop attacking and watch the sand ripple
5. For Sand Spray, circle strafe around the Matriarch's right side
6. When adds spawn, use an AoE spell or familiar ability immediately

**Co-op:**
| Role | Player | Responsibilities |
|------|--------|-----------------|
| Tank | 1 (Cloudpiercer / Wildroot) | Hold aggro, face Matriarch away from group |
| DPS | 1-2 (Any) | Stay on the Matriarch's right side, focus damage |
| Adds Clear | 1 (Wand user, any Coven) | Immediately kill Sand Sprites when they spawn |
| Flex | 0-1 | Support healing or extra DPS as needed |

**Positioning:** Tank holds the Matriarch at the arena center. DPS positions on the right flank. Adds clearer patrols the perimeter and handles spawns.
...
- [Shuddersands Guide: Pre-Quest and Survival](/guides/shuddersands-guide)
- [Lumi Boss Guide: Witchspire Tower Final Boss](/guides/lumi-boss-guide)
