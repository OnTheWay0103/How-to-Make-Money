...
## Co-op Roles — The PvE Equivalent of "Builds"

Since there's no PvP meta, the closest thing to team composition is role coverage in your 4-person coven:

| Role | Best Coven(s) | Job in the group |
|------|---------------|------------------|
| Tank / Survivor | Wildroots | Heal-over-time, thorn armor, face-tanks bosses |
...
**Q: What about the "Shadow/Flame/Frost Coven" names I saw elsewhere?**
Those names don't exist in Witchspire. The six real covens are **Cloudpiercers, Starsmiths, Foretellers, Wildroots, Tomekeepers, and Nightscribes** — see the [Best Coven Guide](/guides/best-coven-guide).

---

## Related Guides

- [Co-op Multiplayer Guide](/guides/coop-multiplayer-guide) — how multiplayer actually works
- [Co-op Troubleshooting Guide](/guides/coop-troubleshooting-guide) — connection, chests and character rules
- [Best Coven Guide](/guides/best-coven-guide) — the six real covens
- [Tier List](/tier-list) — current rankings
- [Patch Notes & Roadmap](/guides/patch-notes-updates) — what's coming through 2027
