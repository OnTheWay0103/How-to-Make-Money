...
export const metadata: Metadata = {
  title: 'All Guides',
  description:
    'Complete Low-Budget Repairs guide collection — money-making strategies, cost-cutting tips, tool comparisons, renovation job guides, and beginner walkthroughs.',
};
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-12">
      ...
      <p className="text-gray-400 mb-8">
        {guides.length} guides covering every aspect of Low-Budget Repairs.
</p>
