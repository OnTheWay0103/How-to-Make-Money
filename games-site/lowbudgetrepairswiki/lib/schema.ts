...
export function videoGameSchema(): Record<string, unknown> {
  return {
    ...
    description:
      'A satirical first-person renovation simulator set in 1990s Polish apartment blocks. Run your own handyman business — cut costs, take shortcuts, water down paint, and maximize profit before the client notices. From Gray2RGB, published by PlayWay S.A.',
    url: 'https://store.steampowered.com/app/3167920/LowBudget_Repairs/',
    applicationCategory: 'Game',
    operatingSystem: 'Windows',
    genre: ['Simulation', 'Indie', 'First-Person', 'Comedy', 'Single-Player'],
    author: {
      '@type': 'Organization',
      name: 'Gray2RGB',
    },
