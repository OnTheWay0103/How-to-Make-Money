/**
 * Next.js Metadata API helpers for Low-Budget Repairs Wiki.
 *
 ...
 *
 * - title uses a template so child pages produce `Page Name · Low-Budget Repairs Wiki`
...
export const defaultMetadata: Metadata = {
  ...
  keywords: [
    'Low-Budget Repairs',
    'Low-Budget Repairs wiki',
    'Low-Budget Repairs guide',
    'Low-Budget Repairs money making',
    'Low-Budget Repairs tips',
    'Low-Budget Repairs beginner guide',
    'Low-Budget Repairs renovation',
    'Low-Budget Repairs cost cutting',
    'Low-Budget Repairs tools',
    'Low-Budget Repairs release date',
  ],
