---
title: "Moonlight Peaks Money Guide — 10 Best Ways to Earn Coins"
...
## The Money Ranking at a Glance

| Rank | Method | When it's viable | Verdict |
|------|--------|------------------|---------|
| 1 | **Potion brewing** | After "Mend it with Magic" | Best coins-per-item in the game — a Love Potion sells for **2200 Coins** |
| 2 | **Crops + processing** | Night 1 onward | Reliable base income; wine beats raw grapes |
| 3 | **Fishing** | Night 1 onward | Steady, low-risk; cook before selling |
| 4 | **Mining + smelting** | After "A Bridge Too Far" | Copper bars feed crafting *and* sell |
| 5 | **Foraging** | Night 1 onward | Free money while you walk |
| 6 | **Dungeon loot** | Mid-game | Bursts of high-value loot |
| 7 | **Festival items** | Seasonal | Limited window, big payouts |
| 8 | **Nokturna matches** | Any night | Zero stamina, zero mana income |
| 9 | **Quest rewards** | Always | Mostly one-time, but several quests pay items worth keeping |
| 10 | **Gift-adjacent selling** | Always | Sell duplicates of loved-gift materials you don't need |

**Pro tip:** the winning strategy is to run **two income systems simultaneously**, not one. Potions for big payouts + farming for steady supply is the community's standard early combo — the potion recipe feeds off crops you grow, so the two systems multiply each other.
...
**Pro tip:** the Love Potion is also the best gift in the game (raises affinity faster than anything), so brewing it is never a waste — if the market doesn't need it, a relationship does.

## 2. Crops and Processing

- **Blood Grapes → Blood Wine** is the game's tutorial chain (Orlock's quest) and a real income stream.
- **Rule of thumb: never sell raw when processing exists.** Wine, juices, and cooked dishes sell for more than their base ingredients.
- **Mystical crops** (Moonlight Flowers, Amour, Hold-Me-Close, Muse Nut) earn more through the potion chain than at the stall.

**Pro tip:** a small, fully-watered field beats a big, half-watered one. Early stamina is scarce, and every unwatered tile is dead money.
...
- Free, stamina-light, available from night one.
- Foraged flowers and materials feed gifts (Azaleas, Moonlight Flowers), potions (Amour, Muse Nut, Hold-Me-Close), and the market.

**Pro tip:** forage on every trip between zones. Ten nights of "while I'm walking anyway" foraging is real money.

## 6. Dungeon Loot

- Dungeons open up as the story progresses — loot runs produce **bursts of high-value items**.
- Time runs around your stamina, not your coins: the loot pays for the trip, the trip costs stamina.

**Pro tip:** don't sell dungeon items blind — several are loved gifts or potion ingredients worth 10x their stall price through the right channel.

## 7. Festival Items

- **Seasonal festivals** bring limited-window items and payouts.
- Festival-exclusive items can't be re-farmed until next year — price accordingly.
- Festivals are also the best date/relationship windows in the game (see the Romance Guide).
...
- One-time, but several quests pay in items that out-earn their coin value.
- **"A Bridge Too Far"** pays in *access* (south map, mine, Death) — the most valuable reward in the game is a bridge.
- Always complete Orlock's Blood Grapes chain and "Mend it with Magic" early — they're income prerequisites.
...
1. **Nights 1–3:** Orlock's Blood Grapes chain; sell processed wine, not grapes.
2. **Nights 4–5:** "Mend it with Magic" — get the cauldron; start Love Potion production.
3. **Nights 5–7:** "A Bridge Too Far" — open the south map, the mine, and Misty Shores fishing.
4. **Nights 7–10:** Rabbicula from **Luna's Farm (2800 Coins)**; rotate farming → potions → fishing daily.
5. **Ongoing:** Nokturna whenever your stamina hits zero; festivals whenever they hit town.

## Money FAQ

**What's the fastest way to make money in Moonlight Peaks?**
**Love Potions** — 2200 Coins each once your cauldron and Luck Dust source (Rabbicula) are running. Before the cauldron, processed crops and cooked fish carry you.

**What sells for 2200 Coins?**
...
The money systems all cross-pollinate: the **Potions Guide** for the full brewing economy, the **Farming Guide** for the crops that feed it, and the **Mining Guide** for the smelted-bar income behind the Yabbis quest.
