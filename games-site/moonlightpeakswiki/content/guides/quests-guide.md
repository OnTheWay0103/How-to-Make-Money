---
title: "Moonlight Peaks Quest Guide — Story Walkthrough & Quest Chains"
...
- **A Bridge Too Far → south map → Death becomes findable**
- **Crest Garden quest → return the Logan Crest → Ambrosia Graveyard cutscene with Death**
...
1. **Do Orlock's quest first** — it's your farming tutorial and income starter.
2. **Never delay the cauldron quest** — "Mend it with Magic" unlocks the potion economy.
3. **"A Bridge Too Far" is priority one** — south map, mine, and Death all sit behind it.
4. **Keep a Copper Bar in storage** — Yabbis demands one, and you don't want to be caught smelting at 3 AM.
5. **Talk to every new character** — the crest quest only triggers through dialogue with Alina, Aras, and Dragan.
6. **Finish the crest quest before deep-diving into romance with Death** — the graveyard cutscene is his introduction.

## Next Steps

The quests feed every other system: the **Mining Guide** covers the Copper Bars Yabbis wants, the **Characters Guide** profiles Fiona, Viktor, Ludo, Saga, and the families behind the quests, and the **Beginner's Guide** shows where these quests sit in your first five nights.
