---
title: "Moonlight Peaks Shapeshifting Guide — Bat, Hellkitten & All Forms"
...
- Shapeshifting is part of the **spell/mana system** — every shift costs **mana**, and your mana pool is deliberately small early on.
- You can only shift at **night** — which is fine, because everything in Moonlight Peaks happens at night.
- Forms are **unlocked through progression**: the first form comes quickly, and later forms arrive as you advance the story and master the spell system.
- While shifted, you keep your character identity and can still interact with the world — each form just changes how you move and what you can reach.

**Pro tip:** shapeshifting is a quality-of-life system, not a requirement. The game never forces a form on you — but the mana-hungry early game means you should learn *when* to shift more than *how*.
...
- **Fastest way around town and the south map.**
- Ideal for: quest delivery runs, reaching **Misty Shores** and the **Ambrosia Graveyard** efficiently, festival nights when you need to be everywhere at once.
- **Watch the mana drain:** long-distance flight is fine, but hovering in place or toggling forms repeatedly burns mana you'll need for spells and potion work.
...
The night clock shapes how you use your forms:

- **Dusk:** bat form to your field or the shops — flight turns commute into play time.
- **Midnight:** hellkitten for foraging sweeps and spiral **dig-spot** hunts (Luck Dust runs).
- **Late night:** bat back before sunrise — the auto-return to your coffin doesn't care how far from home you are, and a long flight at 4 AM is a long walk at 4 AM.

**Pro tip:** the bat form is effectively a time machine. A quest that sends you to **Misty Shores**, the **Ambrosia Graveyard**, and back to town in one night is only comfortable in bat form — budget one Mana Coffee for the trip and it's the most efficient hour of your evening.

## Mana and Stamina Management

| Pool | Shapeshifting's impact |
|------|------------------------|
| **Mana** | Every shift costs mana; flight duration and repeated shifting drain it fastest |
| **Stamina** | Unaffected by shifting — that's the point: flying costs mana, not muscle |
| **Recovery** | Mana-restoring food and drink: **Mana Coffee, Mana Chocolate, Mana Wine**, and Mana dishes |

**Pro tip:** keep one Mana-restoring item on you at all times as a shapeshifting budget. A single Mana Coffee between flights is the difference between a full night's questing and an early forced retreat.

## When to Shift (and When Not To)

**Shift when:**
- Crossing town or the south map (bat).
- Reaching hidden areas, dig spots, and tight access points (hellkitten).
- Festival nights with many errands and a full mana bar.
- Quest chains that send you across multiple zones in one night.

**Don't shift when:**
- Your mana is low and a quest or spell is coming up.
- You're two minutes from the target — walking is free.
- You're managing a tight stamina night (shifting won't help your fields water themselves).

## Shapeshifting FAQ

**How do I unlock bat form?**
...
**Is there a cooldown?**
No cooldown, but repeated shifting drains mana quickly — the real limiter is your pool, which is why early-game advice is to shift deliberately.

## Next Steps

Shapeshifting is a mana system, so it pairs with the **Beginner's Guide** (mana management), the **Quest Guide** (the progression that unlocks forms and the south map you'll fly across), and the **Characters Guide** (the spellcasters who can teach you more).
