...
const FAQ_ITEMS = [
  ...
  { question: 'How many characters can you romance?', answer: '24 dateable residents across the town\'s seven families (Dracula, Ambrosia, Logan, Webb, Khazan, Horseus, and Henderson), plus standalones like Death and Llemi. You can date multiple characters at once.' },
  ...
  { question: 'Is Moonlight Peaks any good?', answer: 'Yes — the developer reported over 200,000 copies sold within three weeks of launch, and the game holds a "Very Positive" rating on Steam. Check the store page for current review figures.' },
];
