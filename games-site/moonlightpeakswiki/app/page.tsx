...
const FEATURED_GUIDES = [
  ...
  { title: 'Romance Guide — All 24 Dateable Characters', description: 'Every dateable resident in Moonlight Peaks, the heart system, how to ask someone out, propose, and get married.', slug: 'romance-guide', category: 'Romance', updated: '2026-07-31' },
...
const FAQ_ITEMS = [
  ...
  { question: 'How many characters can you romance?', answer: '24 dateable residents across the town\'s seven families (Dracula, Ambrosia, Logan, Webb, Khazan, Horseus, and Henderson), plus standalones like Death and Llemi. You can date multiple characters at once, and there is no social penalty for breaking up.' },
