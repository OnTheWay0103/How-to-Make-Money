...
export const metadata: Metadata = {
  title: 'All Guides',
  description:
    'Complete Moonlight Peaks guide collection — beginner tips, romance and gifts, potion recipes, quest walkthroughs, farming, mining, fishing, and money-making guides.',
};
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-12">
      ...
      <p className="text-gray-400 mb-8">
        {guides.length} guides covering every aspect of Moonlight Peaks.
      </p>
