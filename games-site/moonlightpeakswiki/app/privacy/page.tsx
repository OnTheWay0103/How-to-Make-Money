...
export const metadata: Metadata = {
  ...
  description: 'Privacy Policy for Moonlight Peaks Wiki — how we collect, use, and protect your data.',
};
...
export default function PrivacyPage() {
  return (
    <div className="max-w-3xl mx-auto px-4 py-12 prose prose-invert">
      ...
      <p>
        Moonlight Peaks Wiki ("we," "our," or "us") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, and safeguard your information when you visit our website at <strong>moonlightpeakswiki.vercel.app</strong>.
      </p>
