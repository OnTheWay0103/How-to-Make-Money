/**
 * Next.js Metadata API helpers for Moonlight Peaks Wiki.
 *
 ...
 *
 * - title uses a template so child pages produce `Page Name · Moonlight Peaks Wiki`
