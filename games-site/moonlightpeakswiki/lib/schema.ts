...
export function videoGameSchema(): Record<string, unknown> {
  return {
    ...
    description:
      'A gothic cozy vampire farming and life sim. As the child of Count Dracula, farm mystical crops under moonlight, brew potions, romance residents, and restore the town of Moonlight Peaks.',
    url: 'https://store.steampowered.com/app/2209900/Moonlight_Peaks/',
    applicationCategory: 'Game',
    operatingSystem: 'Windows',
    genre: ['Farming Sim', 'Life Sim', 'Cozy', 'Vampire', 'RPG', 'Simulation'],
    author: {
      '@type': 'Organization',
      name: 'Little Chicken Game Company',
    },
    publisher: {
      '@type': 'Organization',
      name: 'XSEED Games',
