...
export const metadata: Metadata = {
  title: 'All Guides',
  description:
    'Complete Fallen Tear: The Ascension guide collection — beginner guide, combat & parrying, Fated Bonds allies, bosses, Temple of Oras, endings, EA-to-1.0 comparison, and more.',
};
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-12">
      ...
      <p className="text-gray-400 mb-8">
        {guides.length} guides covering every aspect of Fallen Tear: The Ascension.
      </p>
