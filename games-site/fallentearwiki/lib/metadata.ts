/**
 * Next.js Metadata API helpers for Fallen Tear: The Ascension Wiki.
 *
 ...
 *
 * - title uses a template so child pages produce `Page Name · Fallen Tear: The Ascension Wiki`
...
export const defaultMetadata: Metadata = {
  ...
  keywords: [
    ...
    'Fallen Tear wiki',
    'Fallen Tear: The Ascension guide',
    'Fallen Tear The Ascension Metroidvania',
    'Fallen Tear Fated Bonds',
    'Fallen Tear bosses',
    'Fallen Tear beginner guide',
    'Fallen Tear Temple of Oras',
  ],
