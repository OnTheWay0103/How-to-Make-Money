 ...
 *
 * Describes Fallen Tear: The Ascension as a software application / video
...
export function videoGameSchema(): Record<string, unknown> {
  return {
    ...
    description:
      'A hand-drawn, story-driven 2D Metroidvania set in the corrupted high-fantasy world of Raoah. Play as Hira, a mysterious child fated to stand against ancient gods, and recruit Fated Bonds allies who change how you fight and explore.',
    url: 'https://store.steampowered.com/app/1446900/Fallen_Tear_The_Ascension/',
    applicationCategory: 'Game',
    operatingSystem: 'Windows',
    genre: ['Metroidvania', 'Action', 'Adventure', 'RPG', 'Side Scroller', '2D', 'Exploration', 'Souls-like'],
    author: {
      '@type': 'Organization',
      name: 'Winter Crew Studios',
    },
    publisher: {
      '@type': 'Organization',
      name: 'CMD Studios',
 ...
 * @example
 *   faqPageSchema([
 *     { question: 'Is Fallen Tear: The Ascension free?', answer: 'No, it is a paid game on Steam.' },
