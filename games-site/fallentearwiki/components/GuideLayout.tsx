    ...
    <article className="max-w-3xl mx-auto px-4 py-8 md:py-12">
      ...
      <header className="mb-8">
        <div className="flex items-center gap-2 mb-3">
          <span className="text-xs font-medium uppercase tracking-wider text-violet-400 bg-violet-400/10 rounded px-2 py-0.5">
      ...
      <div className="prose prose-invert prose-violet max-w-none
        ...
        prose-code:text-violet-300 prose-code:bg-[#1a1a3e] prose-code:px-1 prose-code:py-0.5 prose-code:rounded
        ...
        prose-blockquote:text-gray-400 prose-blockquote:border-violet-500
      ...
      <footer className="mt-12 pt-6 border-t border-[#2a2a5e]">
        <div className="bg-[#1a1a3e]/50 border border-[#2a2a5e] rounded-lg p-4">
          ...
          <div className="text-xs text-gray-500 space-y-1">
            ...
            <p><strong>Sources checked:</strong> Official Steam store page and 1.0 press release, official trailers, developer announcements, and consistent community reports.</p>
            <p className="text-gray-600 mt-2">
              Found an error or outdated info? <a href="/contact" className="text-violet-400 hover:underline">Let us know</a>. This is an unofficial community guide. Game mechanics may change with updates.
            </p>
          </div>
        </div>
      </footer>
