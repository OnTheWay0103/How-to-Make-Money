/**
 * Next.js Metadata API helpers for Waterpark Simulator Wiki.
 *
 ...
 *
 * - title uses a template so child pages produce `Page Name · Waterpark Simulator Wiki`
...
export const defaultMetadata: Metadata = {
  ...
  keywords: [
    'Waterpark Simulator',
    'Waterpark Simulator wiki',
    'Waterpark Simulator guide',
    'Waterpark Simulator tips',
    'Waterpark Simulator beginner guide',
    'Waterpark Simulator slides',
    'Waterpark Simulator staff',
    'Waterpark Simulator museum',
    'Waterpark Simulator research',
    'Waterpark Simulator money',
  ],
