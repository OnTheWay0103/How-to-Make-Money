 ...
 *
 * Describes Waterpark Simulator as a software application / video game so
...
export function videoGameSchema(): Record<string, unknown> {
  return {
    ...
    description:
      'A first-person waterpark management simulator from CayPlay. Design and build custom waterslides, hire and manage staff, research upgrades, keep visitors happy, and grow a rundown park into a five-star attraction. 1.0 adds multiplayer co-op, a Museum questline, and console releases.',
    url: 'https://store.steampowered.com/app/3293260/Waterpark_Simulator/',
    applicationCategory: 'Game',
    operatingSystem: 'Windows',
    genre: ['Simulation', 'Indie', 'Management', 'Comedy', 'Single-Player', 'Co-op'],
    author: {
      '@type': 'Organization',
      name: 'CayPlay',
    },
    ...
    platform: 'Steam, PlayStation 5, Xbox Series X|S',
  };
}
