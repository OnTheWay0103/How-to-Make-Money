...
const FAQ_ITEMS = [
  ...
  { question: 'What platforms is Waterpark Simulator on?', answer: 'Waterpark Simulator is available on PC (Steam), PlayStation 5, and Xbox Series X|S. On Steam Deck the game is officially rated "Playable" — it runs on SteamOS, though some actions need touchscreen or keyboard input and text can be small in places.' },
