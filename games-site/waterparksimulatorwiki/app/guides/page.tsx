...
export const metadata: Metadata = {
  title: 'All Guides',
  description:
    'Complete Waterpark Simulator guide collection — slide tier lists, staff management, research tree, museum questline, visitor happiness, money-making, and beginner walkthroughs.',
};
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-12">
      ...
      <p className="text-gray-400 mb-8">
        {guides.length} guides covering every aspect of Waterpark Simulator.
</p>
