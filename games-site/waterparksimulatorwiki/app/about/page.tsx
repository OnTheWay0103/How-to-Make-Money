...
export const metadata: Metadata = {
  title: 'About Us',
  description: 'About Waterpark Simulator Wiki — an unofficial fan wiki. Learn about our research standards, editorial process, and how we verify game information.',
};
...
export default function AboutPage() {
  return (
    <div className="max-w-3xl mx-auto px-4 py-12 prose prose-invert">
      ...
      <h2>Who We Are</h2>
      <p>
        Waterpark Simulator Wiki is an <strong>unofficial fan-made resource</strong> dedicated to "Waterpark Simulator," the first-person waterpark management simulator developed and published by CayPlay.
      </p>
      <p>
        We research, organize, and verify game information to help players design slides, manage staff, and grow a rundown park into a five-star attraction. Our mission is to be the most helpful and accurate guide resource for the Waterpark Simulator community.
      </p>
      ...
      <h2>Disclaimer</h2>
      <p>
        <strong>Waterpark Simulator Wiki is not affiliated with, endorsed by, or connected to CayPlay or any of its subsidiaries or affiliates.</strong> All game-related trademarks, images, and content are the property of their respective owners. This site is an independent fan project created to support the game's community.
      </p>
      <p>
