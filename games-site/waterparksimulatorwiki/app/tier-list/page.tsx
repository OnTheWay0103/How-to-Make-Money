...
const RIDE_TIERS = [
  ...
  { tier: 'B', items: ['Food & Drink Stalls (hot dog, lemonade, popcorn)'], note: 'Not rides, but among the best profit-per-square-meter in the game. Hot dog stands restock cheaply, lemonade sells at a high margin, and 1.0 adds the popcorn stand. Place near high-traffic zones.' },
