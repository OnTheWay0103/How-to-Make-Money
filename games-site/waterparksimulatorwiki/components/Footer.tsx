...
const footerLinks = [
  ...
  { href: 'https://store.steampowered.com/app/3293260/Waterpark_Simulator/', label: 'Steam', external: true },
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        <div className="flex flex-col items-center gap-4">
          ...
          <p className="text-sm text-gray-500 text-center">
            &copy; 2026 Waterpark Simulator Wiki. Unofficial fan wiki. Waterpark Simulator is a trademark of CayPlay.
          </p>
