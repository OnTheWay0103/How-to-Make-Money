...
const footerLinks = [
  ...
  { href: 'https://store.steampowered.com/app/2950790/IRON_NEST_Heavy_Turret_Simulator/', label: 'Steam', external: true },
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        <div className="flex flex-col items-center gap-4">
          ...
          <p className="text-sm text-gray-500 text-center">
            &copy; 2026 Iron Nest Wiki. Unofficial fan wiki. IRON NEST: Heavy Turret Simulator is a trademark of Nick Nieuwoudt and Dominik Latos.
          </p>
