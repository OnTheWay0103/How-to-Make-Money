---
title: "System Requirements & Performance — Iron Nest Wiki"
...
keywords:
  ...
  - "iron nest minimum specs"
  - "iron nest performance"
  - "iron nest fps"
related:
  - "beginner-guide"
  - "controls-guide"
...
|---|---|
| **OS** | 64-bit processor and OS |
| **CPU** | Intel Core i5-4460 / AMD FX-8350 |
| **RAM** | 4 GB |
| **GPU** | Intel UHD Graphics / AMD Vega 8 (integrated) |
| **DirectX** | Version 10 |
| **Storage** | 5 GB |
...
- **64-bit OS required** — 32-bit systems are not supported.
- **DirectX 10 minimum** — most modern systems exceed this.
- **5 GB free storage** for the install.
- **Cloud saves and Steam Family Sharing** are supported, so multi-PC households can share the campaign progress.

---

## FAQ Cross-Reference

- Is it on Mac or console? **No** — Windows/Steam only (see the [FAQ](/faq)).
- Is there a demo to test performance before buying? **Yes** — the free demo on Steam runs the same engine; if the demo runs, the full game will.
