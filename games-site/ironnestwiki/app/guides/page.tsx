...
export const metadata: Metadata = {
  title: 'All Guides',
  description:
    'Complete IRON NEST guide collection — beginner guides, tactical map plotting, ballistic calculator help, shell types, upgrades and counter-battery tactics.',
};
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-12">
      ...
      <p className="text-gray-400 mb-8">
        {guides.length} guides covering every aspect of IRON NEST: Heavy Turret Simulator.
      </p>
