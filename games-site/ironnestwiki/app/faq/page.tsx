...
const FAQ_ITEMS = [
  ...
  { question: 'When did IRON NEST release?', answer: 'IRON NEST: Heavy Turret Simulator launched on Steam on August 6, 2026. A free demo had been available since earlier in the year and was rated Overwhelmingly Positive on Steam.' },
  { question: 'How much does IRON NEST cost?', answer: 'IRON NEST launched on Steam at a standard price of around €20 (regional pricing applies), with a 25% launch discount during its first weeks. Check the Steam page for the current price. The free demo remains available separately.' },
