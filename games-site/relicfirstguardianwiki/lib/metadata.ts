/**
 * Next.js Metadata API helpers for The Relic: First Guardian Wiki.
 *
 ...
 *
 * - title uses a template so child pages produce `Page Name · The Relic: First Guardian Wiki`
...
export const defaultMetadata: Metadata = {
  ...
  keywords: [
    ...
    'The Relic: First Guardian wiki',
    'The Relic: First Guardian guide',
    'The Relic: First Guardian builds',
    'The Relic: First Guardian weapons',
    'The Relic: First Guardian beginner guide',
    'The Relic: First Guardian tips',
    'The Relic: First Guardian bosses',
  ],
