...
export const metadata: Metadata = {
  title: 'All Guides',
  description:
    'Complete Dressmaker guide collection — release date, price and platforms, the Steam game vs the free itch.io prototype, a beginner guide to the dressmaking loop, Mac and console support, and how Dressmaker differs from DressMaker.',
};
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-12">
      ...
      <p className="text-gray-400 mb-8">
        {guides.length} guides covering the cozy dressmaking simulation by Cozy Lives and Free Lives.
      </p>
