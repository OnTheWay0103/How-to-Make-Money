...
export const metadata: Metadata = {
  ...
  description: 'Privacy Policy for Dressmaker Wiki — how we collect, use, and protect your data.',
};
...
export default function PrivacyPage() {
  return (
    <div className="max-w-3xl mx-auto px-4 py-12 prose prose-invert">
      ...
      <p>
        Dressmaker Wiki ("we," "our," or "us") is an unofficial fan resource covering the video game "Dressmaker," developed by Cozy Lives and published by Free Lives. We are committed to protecting your privacy. This Privacy Policy explains how we collect, use, and safeguard your information when you visit our website at <strong>dressmakerwiki.vercel.app</strong>.
      </p>
