 ...
 *
 * Describes Dressmaker as a software application / video game so
 * rich results can display the Steam link, genre, platform, etc.
 *
 * ⚠️ Attribution: Cozy Lives is the **developer**; Free Lives is the
 * **publisher**. Never collapse the two — Steam reports
 * `developers: ["Cozy Lives"]` and `publishers: ["Free Lives"]`.
 *
 * Price is intentionally omitted — the official price had not been
 * announced as of 2026-09-12 (`price_overview` is null on Steam).
 */
export function videoGameSchema(): Record<string, unknown> {
  return {
    ...
    name: 'Dressmaker',
    description:
      'A cozy dressmaking simulation developed by Cozy Lives and published by Free Lives. Choose fabric, arrange and cut out patterns, sew garments and add decorations — then dress a whole town of customers, or sell pre-made dresses off the rack.',
    url: 'https://store.steampowered.com/app/4019220/Dressmaker/',
 ...
 * @example
 *   faqPageSchema([
 *     { question: 'Is Dressmaker free?', answer: 'No — the game is a paid release, but the itch.io prototype is name-your-price.' },
