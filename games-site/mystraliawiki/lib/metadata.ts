/**
 * Next.js Metadata API helpers for Echoes of Mystralia Wiki.
 *
 ...
 *
 * - title uses a template so child pages produce `Page Name · Echoes of Mystralia Wiki`
...
export const defaultMetadata: Metadata = {
  ...
  keywords: [
    'Echoes of Mystralia',
    'Echoes of Mystralia wiki',
    'Echoes of Mystralia guide',
    'Echoes of Mystralia spell crafting',
    'Echoes of Mystralia builds',
    'Echoes of Mystralia memories',
    'Echoes of Mystralia relics',
    'Echoes of Mystralia beginner guide',
    'Echoes of Mystralia boss guide',
    'Echoes of Mystralia tier list',
    'Mystralia wiki',
    'Borealys Games',
  ],
...
export interface GuideFrontmatter {
  ...
  keywords: string[];
  /** ISO‑8601 date of last content update (e.g. "2026-07-22") */
  updated: string;
 ...
 *     title: 'Spell Crafting Guide',
 *     description: '...',
 *     keywords: ['spell crafting', 'combos'],
 *     updated: '2026-07-22',
