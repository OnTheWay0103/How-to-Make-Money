...
export const SITE_CONFIG = {
  ...
  description:
    'Unofficial Echoes of Mystralia wiki and guide hub — spell crafting builds, 100+ Memories, Guardian boss strategies, progression systems, and beginner guide for the Borealys Games action-RPG roguelite.',
