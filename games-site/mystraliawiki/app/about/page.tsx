...
export const metadata: Metadata = {
  title: 'About Us',
  description: 'About Echoes of Mystralia Wiki — an unofficial fan wiki providing game guides, tips, and strategies.',
};
...
export default function AboutPage() {
  return (
    <div className="max-w-3xl mx-auto px-4 py-12 prose prose-invert">
      ...
      <h2>Who We Are</h2>
      <p>
        Echoes of Mystralia Wiki is an <strong>unofficial fan-made resource</strong> dedicated to "Echoes of Mystralia," the action RPG with spell-crafting.
      </p>
      <p>
        We are a small team of passionate gamers who create comprehensive guides, strategies, and resources to help players master the game. Our mission is to be the most helpful and up-to-date guide resource for the Echoes of Mystralia community.
      </p>
      ...
      <h2>Disclaimer</h2>
      <p>
        <strong>Echoes of Mystralia Wiki is not affiliated with, endorsed by, or connected to the developers or publishers of Echoes of Mystralia.</strong> All game-related trademarks, images, and content are the property of their respective owners. This site is an independent fan project created to support the game's community.
      </p>
    </div>
  );
}
