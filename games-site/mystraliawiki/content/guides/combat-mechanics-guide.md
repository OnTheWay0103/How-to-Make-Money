...
Three confirmed design statements anchor the combat:

1. **Action-heavy and rapid** — combat rewards split-second decisions, not deliberate menu-ing
2. **Movement is a core skill** — "precise movement" is called out in the developer's own description of the combat
3. **Your spells are your only weapons** — from the Steam description: **"Memories are your only weapon against the Shadows of the Past."** There is no weapon loot or gear layer; your crafted loadout IS your arsenal

The roguelite frame is confirmed too: **you lose progress on death but keep some upgrades and Memories**, and each run builds toward a stronger character. Death is a setback, not a restart.

## Movement & Dodging Fundamentals (Demo-Verified)

The demo teaches the movement layer directly. What you can verify by play:

- **Dodging is your core defense** — positioning and dodges, not damage-sponging, keep you alive
- **Read the wind-up, then dodge** — the demo's enemies telegraph attacks; reacting to the tell beats panic-rolling
- **Manage space between bursts** — get distance when unsure, close in during openings
- **Don't overcommit** — greedy casting after a dodge is how most deaths happen; one safe hit pattern beats a dead run
- **The arena matters** — fight-challenge arenas and Therakan's arena include hazards and space constraints; watch the environment, not just the enemy

These patterns are confirmed by play in the demo and are the same skills the harder launch regions will test.

## Who You Fight (Confirmed Enemy Layers)

The official material names the enemy roster at three levels:

| Enemy layer | Confirmed details |
|-------------|-------------------|
...
## How Crafted Spells Execute (The Combat-Crafting Bridge)

The crafting system happens *before* the fight; execution happens *during* it. The confirmed bridge between the two:
...
## What's TBD (Will Be Documented After Launch)

- I-frame timing and dodge properties — **TBD**
- Elemental match-ups and status effects (burn, freeze, stun) — **TBD** — do not trust pre-launch counter tables
- Enemy attack patterns and boss rotations — **TBD**
- Elite fight layouts at launch — **TBD**
- Any stamina/resource systems on dodging — **TBD**

The demo build and the EA build may differ — Borealys has already changed systems once between them. This guide will be updated from the verified EA build.
