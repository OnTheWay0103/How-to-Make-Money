...
# Ash Forest Region Guide — The Demo Region & Therakan
...
|-----------|--------|--------|
| **Name** | The Ash Forest | ✅ Confirmed |
| **Role** | First region / demo biome | ✅ Confirmed |
| **Boss** | **Therakan**, the first primordial Guardian | ✅ Confirmed |
...
The Ash Forest is a burned woodland — charred terrain and ember-strewn air, matching the game's story of a land scarred by war and exploitation. It functions as the tutorial space: you learn movement, dodging, spellcasting, and Memory harvesting here before the harder regions at launch.
...
The demo includes **4 fight challenges** — scripted combat encounters separate from the main run. These are excellent practice: they teach elite-style enemy behavior and reward you with a steady source of Memories. Details of challenge objectives and rewards are **TBD** (the demo build and EA build may differ).

### The 50 Memories

All 50 demo Memories can drop or be earned in the Ash Forest. Because Memories are **reordered and combined** into spells, the region effectively contains the demo's entire crafting sandbox — kill, harvest, and experiment.

## What Remains TBD (Not Confirmed)

To keep this guide honest, here's what we still don't know about the Ash Forest:

- **Full enemy list** — Borealys confirms Rift-spawned foes and "Shadows of the Past" as enemy types, but individual enemy names and behaviors are not officially documented
- **Elite and mini-boss encounters** — not officially confirmed; don't trust any list of "elite spawns" circulating pre-launch
- **Secret rooms and hidden loot** — the demo may contain hidden content, but nothing is officially documented
- **Chest and drop rates** — not published by the developer
- **Exact region size and routing** — the demo region is not the final EA region; Borealys may expand it
- **Elemental advantages** — community theories exist, but the developer has not confirmed an elemental match-up system for Echoes of Mystralia
...
## Completion Checklist (Demo)

- [ ] Complete a full Ash Forest run
- [ ] Defeat Therakan
- [ ] Complete all 4 fight challenges
- [ ] Collect and experiment with all 50 Memories
- [ ] Unlock all 4 base spells

## Related Guides

- [Boss Guide](/guides/boss-guide) — Guardian strategies and what we know about Therakan
- [Beginner Guide](/guides/beginner-guide) — first steps before entering the region
- [Memories Guide](/guides/memories-guide) — everything confirmed about the Memory system
- [EA Launch Guide](/guides/ea-launch-guide) — how the demo connects to Early Access
