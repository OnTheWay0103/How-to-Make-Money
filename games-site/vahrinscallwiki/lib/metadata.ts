/**
 * Next.js Metadata API helpers for Vahrin's Call Wiki.
 *
 ...
 *
 * - title uses a template so child pages produce `Page Name · Vahrin's Call Wiki`
...
export const defaultMetadata: Metadata = {
  ...
  keywords: [
    ...
    "Vahrin's Call wiki",
    "Vahrin's Call guide",
    "Vahrin's Call builds",
    "Vahrin's Call weapons",
    "Vahrin's Call beginner guide",
    "Vahrin's Call magic",
    "Vahrin's Call alchemy",
    "Vahrin's Call bosses",
    "Vahrin's Call skill books",
    'Forsaken Realms',
    'Forsaken Realms Vahrins Call',
    'Titan Roc',
  ],
