 ...
 *
 * Describes Vahrin's Call as a software application / video game so
...
export function videoGameSchema(): Record<string, unknown> {
  return {
    ...
    name: "Vahrin's Call",
    description:
      "A narrative-driven, classless action-RPG set in the war-torn city of Vahrin. Play as a mercenary, master weapons and magic, craft potions and traps, and fight to reclaim a fallen kingdom from the insect-like khraiax.",
    url: 'https://store.steampowered.com/app/951770/Forsaken_Realms_Vahrins_Call/',
    applicationCategory: 'Game',
    operatingSystem: 'Windows',
    genre: ['Action RPG', 'Fantasy', 'Dark Fantasy', 'Single-player', 'Exploration'],
    author: {
      '@type': 'Organization',
      name: 'Titan Roc',
    },
 ...
 * @example
 *   faqPageSchema([
 *     { question: "Is Vahrin's Call free?", answer: 'No, it costs $34.99 on Steam.' },
