...
export const metadata: Metadata = {
  title: 'All Guides',
  description:
    "Complete Vahrin's Call guide collection — beginner tips, best builds, weapon guides, magic spells, boss strategies, skill book locations, alchemy recipes, and more.",
};
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-12">
      ...
      <p className="text-gray-400 mb-8">
        {guides.length} guides covering every aspect of Vahrin&apos;s Call.
      </p>
