...
export const metadata: Metadata = {
  title: 'About Us',
  description: 'About Vahrins Call Wiki — an unofficial fan wiki providing game guides, tips, and strategies.',
};

export default function AboutPage() {
  return (
    <div className="max-w-3xl mx-auto px-4 py-12 prose prose-invert">
      <h1>About Vahrins Call Wiki</h1>

      <h2>Who We Are</h2>
      <p>
        Vahrins Call Wiki is an <strong>unofficial fan-made resource</strong> dedicated to "Vahrins Call," the cooperative PvE extraction horror game developed by SpiritVale Studio and published by NACON.
      </p>
      <p>
