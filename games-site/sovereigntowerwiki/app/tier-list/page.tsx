...
export const metadata: Metadata = {
  title: 'Tier List',
  description:
    'The honest state of Sovereign Tower tier rankings — why early rankings need play data, and the confirmed systems worth evaluating.',
};
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-12 text-center">
      ...
      <p className="text-gray-400 mb-6">
        This page has moved. The honest state of Sovereign Tower rankings — and why legitimate
