...
export const metadata: Metadata = {
  title: 'All Guides',
  description:
    'Complete Sovereign Tower guide collection — beginner tips, knight recruitment, romance options, factions, time rewind, and more.',
};
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-12">
      ...
      <p className="text-gray-400 mb-8">
        {guides.length} guides covering every aspect of Sovereign Tower.
      </p>
