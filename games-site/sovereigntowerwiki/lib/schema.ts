 ...
 *
 * Describes Sovereign Tower as a software application / video game so
...
export function videoGameSchema(): Record<string, unknown> {
  return {
    ...
    description:
      'A story-rich, round-table management RPG from WILD WITS. Rule as the Sovereign of a magical tower: recruit eccentric knights, assign them to quests, balance the factions of the realm, and rewind time with the help of a Demon in the crypts to rewrite fate.',
    url: SITE_CONFIG.url,
    applicationCategory: 'Game',
    operatingSystem: 'Windows',
    genre: ['Management', 'RPG', 'Visual Novel', 'Medieval Fantasy', 'Indie'],
    author: {
      '@type': 'Organization',
      name: 'WILD WITS',
    },
