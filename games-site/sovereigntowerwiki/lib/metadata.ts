/**
 * Next.js Metadata API helpers for Sovereign Tower Wiki.
 *
 ...
 *
 * - title uses a template so child pages produce `Page Name · Sovereign Tower Wiki`
...
export const defaultMetadata: Metadata = {
  ...
  keywords: [
    ...
    'Sovereign Tower beginner guide',
    'Sovereign Tower knights',
    'Sovereign Tower romance',
    'Sovereign Tower recruitment',
    'Sovereign Tower factions',
    'Sovereign Tower time rewind',
    'round-table management RPG',
    'WILD WITS',
    'Curve Games',
  ],
