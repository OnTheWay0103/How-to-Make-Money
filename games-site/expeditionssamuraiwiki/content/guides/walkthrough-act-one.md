---
title: "Expeditions: Samurai Act One Walkthrough — Complete Story Route"
description: "The complete Expeditions: Samurai Act One walkthrough — from the De Albatros arrival to the road to Sekigahara, with the confirmed story beats, choices, and what to do in each phase."
...
> Early Access Build (Act One, ~8 hours) / Updated: August 1, 2026
...
Act One is built on the world map structure: **45+ levels and 100+ events/encounters** across the full game, with quests doable in any order. For Act One specifically:

- **Do side content early.** The world map is open — the game never hard-locks you. If a main quest fight is too hard, go level elsewhere.
...
**Goal:** Stabilize the crew.

- Tend everyone's injuries — a debuffed crew fails the first checks.
- Scavenge supplies from the wreck and shore.
- Do the first tutorial encounters with stealth and combat.
- **Pro tip:** the first hours teach the three pillars — deliberately try each one at least once to feel the system.

### Phase 2: First Contact (Hours 2-4)
...
### Phase 3: The Power Play (Hours 4-6)
...
## Choices That Matter in Act One

Based on the official framing, watch for these choice types:

- **Faction allegiance** — who you serve now determines your political starting position in later acts.
- **Companion loyalty calls** — moments where you can gain a companion's trust or earn their rivalry.
- **Pillar decisions** — stealth vs. diplomacy vs. steel resolutions that lock how the world remembers you.
- **Resource gambles** — spending supplies on opportunities that may or may not pay off.

## What You Can't Reach in Act One (Yet)

Some content is deliberately out of reach in Early Access:

- **Acts Two-Four** — arriving via the story update and the full 1.0 release (~60 hours total).
- **Village management** — added during Early Access development, tied to the Hatamoto rank.
- **The full crafting catalog** — more weapons, armor, and quests arrive in the two content updates.

## Act One Completion Checklist
...
**Next up:** master the systems the walkthrough uses in the [Combat Guide](/guides/combat-guide) and [Stealth Guide](/guides/stealth-guide).
