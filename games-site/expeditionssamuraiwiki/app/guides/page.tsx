...
export const metadata: Metadata = {
  title: 'All Guides',
  description:
    'Complete Expeditions: Samurai guide collection — classes, builds, companions, stealth tactics, combat strategies, co-op, village management and more.',
};
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-12">
      ...
      <p className="text-gray-400 mb-8">
        {guides.length} guides covering every aspect of Expeditions: Samurai — from your first expedition to village rule.
      </p>
