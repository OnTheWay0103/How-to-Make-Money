/**
 * Next.js Metadata API helpers for Expeditions: Samurai Wiki.
 *
 ...
 *
 * - title uses a template so child pages produce `Page Name · Expeditions: Samurai Wiki`
...
export const defaultMetadata: Metadata = {
  ...
  keywords: [
    'Expeditions: Samurai',
    'Expeditions: Samurai wiki',
    'Expeditions: Samurai guide',
    'Expeditions: Samurai builds',
    'Expeditions: Samurai classes',
    'Expeditions: Samurai companions',
    'Expeditions: Samurai stealth',
    'Expeditions: Samurai beginner guide',
    'Expeditions: Samurai tips',
    'Expeditions: Samurai co-op',
  ],
