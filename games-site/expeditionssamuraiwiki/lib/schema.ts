 ...
 *
 * Describes Expeditions: Samurai as a software application / video game so
...
export function videoGameSchema(): Record<string, unknown> {
  return {
    '@context': 'https://schema.org',
    '@type': 'VideoGame',
    name: 'Expeditions: Samurai',
    description:
      'A party-based tactical CRPG set in Sengoku-era Japan, 1600 AD. Lead Captain Flynn and your crew of privateers through the civil war with stealth, diplomacy, or steel — romance companions, manage your village, and play the entire campaign in 2-player co-op.',
    url: 'https://store.steampowered.com/app/2212910/Expeditions_Samurai/',
    applicationCategory: 'Game',
    operatingSystem: 'Windows',
    genre: ['RPG', 'CRPG', 'Strategy', 'Tactical', 'Turn-Based', 'Historical', 'Stealth', 'Co-op'],
    author: {
      '@type': 'Organization',
      name: 'Campfire Cabal',
    },
