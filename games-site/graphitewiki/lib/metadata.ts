/**
 * Next.js Metadata API helpers for Graphite Wiki.
 *
 ...
 *
 * - title uses a template so child pages produce `Page Name · Graphite Wiki`
...
export const defaultMetadata: Metadata = {
  ...
  keywords: [
    ...
    'Graphite heroes',
    'Graphite tier list',
    'Graphite combat guide',
    'Graphite tactical roguelike',
    'Graphite Break system',
    'RipRed',
    'indie.io',
  ],
