...
export const metadata: Metadata = {
  title: 'All Guides',
  description:
    'Complete Echoes of Aincrad guide collection — weapon classes, builds, boss strategies, EX-Mod crafting, progression tips, and more.',
};
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-12">
      ...
      <p className="text-gray-400 mb-8">
        {guides.length} guides covering every aspect of Echoes of Aincrad.
      </p>
