...
export const metadata: Metadata = {
  ...
  description: 'Echoes of Aincrad weapon tier list — best weapon rankings for solo, DPS, and beginner play. S-tier to C-tier rankings for all 6 weapon types.',
};
...
export default function TierListPage() {
  return (
    <div className="max-w-3xl mx-auto px-4 py-12">
      ...
      <p className="text-gray-400 mb-2">Echoes of Aincrad weapon rankings for launch (July 10, 2026). Based on demo data.</p>
      ...
      <div className="bg-[#1a1a3e] border border-[#2a2a5e] rounded-lg p-5">
        ...
        <p className="text-gray-400 text-sm leading-relaxed">
          Echoes of Aincrad launches July 10, 2026. All six weapons are viable — weapon mastery
