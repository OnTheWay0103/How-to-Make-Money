...
export const metadata: Metadata = {
  title: 'About Us',
  description: 'About Aincrad Wiki — an unofficial fan wiki providing game guides, tips, and strategies.',
};

export default function AboutPage() {
  return (
    <div className="max-w-3xl mx-auto px-4 py-12 prose prose-invert">
      <h1>About Aincrad Wiki</h1>

      <h2>Who We Are</h2>
      <p>
        Aincrad Wiki is an <strong>unofficial fan-made resource</strong> dedicated to "Echoes of Aincrad," the cooperative PvE extraction horror game developed by SpiritVale Studio and published by NACON.
      </p>
      <p>
