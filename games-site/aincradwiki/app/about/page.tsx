...
export const metadata: Metadata = {
  title: 'About Us',
  description: 'About Echoes of Aincrad Wiki — an unofficial fan wiki providing game guides, tips, and strategies.',
};
...
export default function AboutPage() {
  return (
    <div className="max-w-3xl mx-auto px-4 py-12 prose prose-invert">
      ...
      <h2>Who We Are</h2>
      <p>
        Echoes of Aincrad Wiki is an <strong>unofficial fan-made resource</strong> dedicated to "Echoes of Aincrad," the pixel-art action RPG roguelite inspired by Sword Art Online.
      </p>
      <p>
        We are a small team of passionate gamers who create comprehensive guides, strategies, and resources to help players master the game. Our mission is to be the most helpful and up-to-date guide resource for the Echoes of Aincrad community.
      </p>
