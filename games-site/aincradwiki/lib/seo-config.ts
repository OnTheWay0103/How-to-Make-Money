...
/**
 * Global SEO configuration for Aincrad Wiki.
 *
...
export const SITE_CONFIG = {
  ...
  shortName: 'Aincrad Wiki',

  /** Default meta description — shown in search-engine snippets. */
  description:
    'Unofficial Echoes of Aincrad wiki and guide hub — weapon classes, builds, bosses, EX-Mods, progression tips and beginner guide for the Sword Art Online action RPG.',

  /** Canonical base URL (trailing slash omitted). */
  url: 'https://aincradwiki.vercel.app',
  ...
  googleAnalyticsId: 'G-109H13Q3KN',
