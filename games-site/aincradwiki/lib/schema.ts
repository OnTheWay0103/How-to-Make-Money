...
export function videoGameSchema(): Record<string, unknown> {
  return {
    ...
    description:
      'A single-player action JRPG set in the Sword Art Online universe. Create your own avatar, master 6 weapon classes, fight through the floors of Aincrad with AI partners, and survive the death game.',
    url: 'https://store.steampowered.com/app/echoes-of-aincrad',
    applicationCategory: 'Game',
    operatingSystem: 'Windows',
    genre: ['Action RPG', 'JRPG', 'Anime', 'Single-player'],
    author: {
      '@type': 'Organization',
