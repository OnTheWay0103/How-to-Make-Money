...
Most magic skills require a channel time (1-3 seconds). While channeling:
- You cannot move
- You cannot block or dodge
- Interrupting the channel wastes the SP cost

Positioning and timing are critical. Every cast is a commitment.

### Elemental Affinity

Your spells have elemental types. Matching element to enemy weakness deals **+50% bonus damage**:

| Element | Effective Against | Weak Against |
|---------|-----------------|--------------|
| Fire | Golem, Plant | Water, Ice |
| Ice | Beast, Fire | Fire, Earth |
| Lightning | Aquatic, Flying | Earth, Fire |
| Arcane | All (neutral) | None (no bonus) |

### Mana Shield

A toggle skill that converts SP drain to mana absorption. While active, 40% of incoming damage is deducted from SP instead of HP. Essential for survival but dangerous if your SP runs dry mid-fight.

## Best Magic Skills

| Skill | Type | When to Use |
|-------|------|------------|
| **Fireball** | Single-target burst | Standard damage rotation |
| **Ice Storm** | AoE slow | Farming mob packs, crowd control |
| **Lightning Bolt** | Fast cast | Mobile enemies, interrupt casts |
| **Arcane Blast** | High-damage finisher | Boss damage phases, stunned enemies |
| **Mana Shield** | Defense toggle | Every difficult fight, always on |
| **Teleport** | Short blink | Repositioning, dodging telegraphed attacks |

## Stat Priority

| Stat | Investment | Why |
|------|-----------|-----|
| Intelligence | 60% | Spell damage scaling — your core stat |
| Endurance | 25% | SP pool and regen for casting |
...
### Standard Combat
Fireball → Ice Storm (if multiple enemies) → Lightning Bolt (fast filler) → repeat

### Boss Damage Phase (Stunned Enemy)
Arcane Blast (max channel) → Fireball → Lightning Bolt → Ice Storm

### AoE Farming
Ice Storm (slow pack) → Fireball (center) → Lightning Bolt (stragglers)
...
| Aspect | Rating | Notes |
|--------|--------|-------|
| Damage | S-tier | Highest burst, but you need distance |
| Survivability | C-tier | Glass cannon. One mistake is often fatal. |
| Farming Speed | S-tier | AoE clears packs instantly |
| Bossing | B-tier | Dangerous. Requires perfect positioning. |

**Solo mage is high-risk, high-reward.** You delete enemies before they reach you — but if they do reach you, you are in serious trouble.
