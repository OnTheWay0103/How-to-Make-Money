...
|---|------|------|:--:|------|:--:|------|------|
| 1 | **ReStory: Chill Electronics Repairs** | 怀旧电器维修模拟 (Mandragora/tinyBuild) | **22** | 8/6 已上线 | ❌ 无 | 8/8 | **强烈推荐** — 700-771K wishlist，98% Overwhelmingly Positive（570+ 评测），12K+ 峰值 CCU，Metacritic 84-85/OpenCritic 89，tinyBuild 史上最高分游戏；12 小时回本；零 wiki（仅 2UpSkill/gamerblurb 等文章攻略）；50 成就+2000 设备+15h 分支剧情，内容面广 |
| 2 | **Fallen Tear: The Ascension** | 手绘 Metroidvania (Winter Crew/CMD) | **18** | 9/16 1.0 | ❌ 无 | 8/8 | **推荐** — EA 200+ 评测 Very Positive；1.0 内容翻倍：20 区域、33 Boss、21 Fated Bonds、80h 全收集；零 wiki（仅新闻稿）；Metroidvania 长尾极佳；建议 9 月初建站蓄势 |
| 4 | **Waterpark Simulator** | 水上乐园管理模拟 (CayPlay) | **17** | 7/31 1.0 | ❌ 无 | 8/8 | **推荐** — 1M+ 下载、96% Overwhelmingly Positive（7400+ 评测）、10.5K 峰值 CCU、$12.99；零 wiki（仅文章攻略）；50M 订阅 YouTuber 出品，1.0 含博物馆任务线/员工管理/研究系统，内容面达标；模拟品类已验证（Low-Budget Repairs/Go-Go Town 先例） |
...
| 18 | Dig, Dig, Die | 6人 Co-op 恐怖 | 14 | 8/6 | ❌ 无 | 8/1 | 观望（小团队 <10人） |
| 19 | Frozen Ship | 生存建造 | 14 | 8/7 EA | ❌ 无 | 8/1 | 观望 |
| 20 | Polylithic | 石器时代生存 Co-op | 13 | 8/25 1.0 | ❌ 无 | 8/1 | 观望（EA已3年，1.0新窗口） |
| 21 | Pax Autocratica | 殖民模拟 FPS Roguelite | 13 | 8/10 EA | ❌ 无 | 8/1 | 观望 |
| 22 | Lootbound | 回合制战术 Roguelite | 13 | 8/14 | ❌ 无 | 8/1 | 观望 |
| 23 | Tiny Eden | 室内温馨农场模拟 (Bajka Games) | 14 | 9/7 | ❌ 无 | 8/8 | 观望（wishlist 无数据；demo 已上；名字"Tiny Eden"泛化风险；Moonlight Peaks 先例但体量偏小） |
| 24 | Cosmic Fear | Lovecraft 恐怖冒险（单人开发） | 13 | 9/9 | ❌ 无 | 8/8 | 观望（Land of Pain/Alien Cube 系列小众；线性恐怖解谜内容有限） |
| 25 | Pass the Fear | Co-op Roguelite 弹幕 | ~~16~~ **12** | 7/22 已上线 | ⚠️ 已有 wiki | 8/1 | ⚠️ 降级 — 8/1 深度调研发现 passthefear.wiki 已存在（含 build planner），关键词仅 18 个 |
...
| Nivalis Nights | 22 | 8/7 | nivalisnightswiki — 932K wishlist，生活模拟，10 guides |
...
> ⚠️ 完整已建站清单（30 站）见 `dashboard/lib/sites.ts` 与 `.agent/build-history.json`。
